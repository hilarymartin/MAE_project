...
if(!print.only){
 ...
 print(model1.6.mat,pars=c("beta_Age","beta_global","sigmasq_global","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
} else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
...
if(!print.only){
    ...
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
...
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
...
print(model1.5.mat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.all_chains.mat.including_alpha.RData"))
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.all_chains.mat.including_alpha.RData")
}
...
print(model1.5.pat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.all_chains.pat.including_alpha.RData"))
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.all_chains.pat.including_alpha.RData")
}
...
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
my.ylim=55
for(i in 1:ncol(mysim$beta_Age)){
    if(i==1){
        plot(density(mysim$beta_Age[,i]),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
...
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()
}
...
if(!print.only){
    ...
    model1.5.mat <- sflist2stanfit(model1.5.mat.list)
print(model1.5.mat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
   save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.different_link.all_chains.mat.including_alpha.RData"))
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.different_link.all_chains.mat.including_alpha.RData")
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.txt",header=T)
    myname="maternal"
 ...
 if(!print.only){
    ...
    model1.5.pat <- sflist2stanfit(model1.5.pat.list)
 print(model1.5.pat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.different_link.all_chains.pat.including_alpha.RData"))
 } else {
load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.different_link.all_chains.pat.including_alpha.RData")
}
    mysim<-extract(model1.5.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.txt",header=T)
    myname="paternal"
}
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.different_link.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.different_link.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()
}
...
if(!print.only){
    ...
    model1.5.mat <- sflist2stanfit(model1.5.mat.list)
 print(model1.5.mat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.different_link.weaker_priors.all_chains.mat.including_alpha.RData"))
} else {
load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.different_link.weaker_priors.all_chains.mat.including_alpha.RData")
}
...
####Need to run this for longer - didn't converge
    ...
    model1.5.pat <- sflist2stanfit(model1.5.pat.list)
print(model1.5.pat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.different_link.weaker_priors.all_chains.pat.including_alpha.RData"))
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.different_link.weaker_priors.all_chains.pat.including_alpha.RData")
}
...
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.different_link.weaker_priors.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.different_link.weaker_priors.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()
}
...
if(FALSE){
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".traceplots.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
#//        curve(dnorm(x,mean_alpha_prior,sqrt(5)),add=T,lwd=3,lty=2)
    ...
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.4.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.4.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.txt",header=T)
    myname="maternal"
    ...
    if(!print.only){
        ...
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.4.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.4.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.txt",header=T)
    myname="paternal"
...
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.4.",myname,".posteriors.beta_Age.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
abline(v=0,lwd=2)
dev.off()

pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.4.",myname,".posteriors.mu_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.4.",myname,".posteriors.sigmasq_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.4.",myname,".posteriors.omega.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
if(!print.only){
    ...
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==55){
        myname="uniform_priors_on_beta_Age.maternal"
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==57){
        myname="uniform_priors_on_mu_m_cohort.maternal"
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==59){
        myname="uniform_priors_on_tau.maternal"
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==61){
        myname="uniform_priors_on_sigma_m.maternal"
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.mat.including_alpha.RData"))
    }
} else{
    if(argv[1]==47){
        myname="uniform_priors.maternal"
             load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors.all_chains.mat.including_alpha.RData")
        }
    if(argv[1]==55){
        myname="uniform_priors_on_beta_Age.maternal"
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==57){
        myname="uniform_priors_on_mu_m_cohort.maternal"
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.mat.including_alpha.RData"))
    }
      if(argv[1]==59){
          myname="uniform_priors_on_tau.maternal"
          load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.mat.including_alpha.RData"))
      }
        if(argv[1]==61){
            myname="uniform_priors_on_sigma_m.maternal"
            load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.mat.including_alpha.RData"))
        }
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.txt",header=T)
...
if(!print.only){
    ...
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
                                        #    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors.all_chains.pat.including_alpha.RData")
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==56){
        myname="uniform_priors_on_beta_Age.paternal"
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==58){
        myname="uniform_priors_on_mu_m_cohort.paternal"
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==60){
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.pat.including_alpha.RData"))
        myname="uniform_priors_on_tau.paternal"
    }
    if(argv[1]==62){
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.pat.including_alpha.RData"))
...
#pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.uniform_priors.v4.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
        if(argv[1] %in% c(47,55,57,59,61)){
        my.ylim=0.6
        my.xlim=c(32,46)
    }else {
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
        if(argv[1] %in% c(47,55,57,59,61)){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.tausq.pdf"),height=5,width=5)
...
if(!print.only){
   model1.5.mat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.5.4.uniform_priors.stan",data=data1.mat2,iter=10000,chains=0)
    ...
    model1.5.mat <- sflist2stanfit(model1.5.mat.list)
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.4.uniform_priors.all_chains.mat.including_alpha.RData"))
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.4.uniform_priors.all_chains.mat.including_alpha.RData")
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.txt",header=T)
    myname="maternal"
    ...
    if(!print.only){
        ...
        model1.5.pat <- sflist2stanfit(model1.5.pat.list)
        print(model1.5.pat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.4.uniform_priors.all_chains.pat.including_alpha.RData"))
    } else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.5.4.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
}
    mysim<-extract(model1.5.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.txt",header=T)
    myname="paternal"
...
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.4.uniform_priors.v4.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
abline(v=0,lwd=2)
dev.off()


pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.4.uniform_priors.v4.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
if(myname=="maternal"){
    my.ylim=1.7
} else {
    my.ylim=1.7
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.4.uniform_priors.v4.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=1
        my.xlim=10
    }else {
...
dev.off()
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.5.4.uniform_priors.v4.",myname,".posteriors.omega.pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
...
if(!print.only){
    ...
    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".RData"))
} else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.txt",header=T)
    myname="maternal"
 ...
 if(!print.only){
    ...
    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas.df_",df.alpha,".RData"))
}else{
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas.df_",df.alpha,".RData"))
 }
    mysim<-extract(model1.6.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.txt",header=T)
    myname="paternal"
...
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.beta_Age.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    if(myname=="maternal"){
    ...
    dev.off()
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.mu_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.sigmasq_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.tausq.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),xlab="tausq",main="Posterior for tausq",lwd=2)
    lines(density(rigamma(10000,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
...
load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".RData"))
}
...
load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas_and_Y.df_",df.alpha,".RData"))
}
     mysim<-extract(model1.6.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.txt",header=T)
    myname="paternal"
...
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    if(myname=="maternal"){
    ...
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){my.ylim=0.6}else {my.ylim=0.7}
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
    ...
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    legend("topright",c(as.character(cohort.codes[order(cohort.codes[,1]),2]),"prior"),col=c(mycols[as.character(cohort.codes[,2])],"black"),lty=c(rep(1,nrow(cohort.codes)),2),lwd=c(rep(2,nrow(cohort.codes)),3),cex=0.5)
    dev.off()
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),xlab="tausq",main="Posterior for tausq",lwd=2)
    lines(density(rigamma(10000,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
...
##    mean_alpha_prior=38
    ...
    print(model1.6.mat,pars=c("beta_Age","beta_Agesq","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.with_agesq_term.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.modell1.6.2.with_agesq_term.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,                ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.txt",header=T)
...
#       legend("topright",c("Adam","decode","Hutterites","Julie"),lty=c(2,3,4,4),lwd=2,col=c("black","black","black","grey"),cex=0.5)
    ...
    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/model1.6.2.",myname,".posteriors.beta_Agesq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
#    data1.mat2$cohort_by_family = cohort_by_family
    ...
    if(!print.only){ 
    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.",myname,".all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.mat,permuted=T)
    ...
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.",myname,".all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",                sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.mat,permuted=T)
}
 ...
 #   }
  #  data1.pat2$cohort_by_family = cohort_by_family
     ...
     if(!print.only){
         model1.6.pat <- sflist2stanfit(model1.6.pat.list)
         save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.",myname,".all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
         mysim<-extract(model1.6.pat,permuted=T)
    if("beta_global" %in% names(mysim)){
        ...
        print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
         ...
         load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/RSTAN.",myname,".all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
         mysim<-extract(model1.6.pat,permuted=T)
     }

 }
if(FALSE){
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/",myname,".traceplots.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    traceplot(model1.6.mat,pars=c("beta_Age"),window=c(10^2,10^4))
    traceplot(model1.6.mat,pars=c("mu_m"),window=c(10^2,10^4))
    traceplot(model1.6.mat,pars=c("sigmasq_m"),window=c(10^2,10^4))
    traceplot(model1.6.mat,pars=c("tausq"),window=c(10^2,10^4))
...
pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    my.ylim=100
    if(!"beta_global" %in% names(mysim)){
        plot(density(mysim$beta_Age),xlim=c(-0.5,0.5),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
        abline(v=0,lwd=2)
...
#       legend("topright",c("Adam","decode","Hutterites","Julie"),lty=c(2,3,4,4),lwd=2,col=c("black","black","black","grey"),cex=0.5)
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    plot(density(mysim$sigmasq_m),xlab="sigmasq_m",main="Posterior for sigmasq_m",lwd=2)
    lines(density(rigamma(10000,sigmasq_m_alpha,sigmasq_m_beta)),lwd=3,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()

    pdf(paste0("RSTAN_output_with_NFTOOLS_more_stringent/",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),lwd=2,main="Posterior for tausq",xlab="tausq")
    lines(density(rigamma(10000,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lty=c(1,2),lwd=2)
    dev.off()
