if(FALSE){
  outdir="/home/hilary/maternal_age_recombination/paper/figures/with_new_QTR"
...
#pdf(paste0(outdir,"/crossover_count_by_binned_age.duoHMM_informative_duos_only.no_GPC.pdf"),height=5,width=5)
...
plot(mat.binned.rec$x,mat.binned.rec$mean,xlab="Parental age, binned",ylab="Difference from 20-25 age group",col="red",ylim=c(-4,4),pch=19,xaxt="n")
axis(1,at=c(17.5,22.5,27.5,32.5,37.5,42.5)+0.25,labels=c("<20","20-25","26-30","31-35","36-40",">40"))
...
text(mat.binned.rec$x,rep(4,6),labels = mat.table,col="red")
text(mat.binned.rec$x,rep(3.3,6),labels = pat.table,col="blue")
...
load("frequentist_analysis/more_stringent/frequentist_analysis_of_MAE.no_nkids_term.with_new_QTR.RData")
...
write.table(combined,"/home/hilary/maternal_age_recombination/paper/summary_of_LMM_results.with_new_QTR.txt",quote=F,sep="\t")



summary.duohmm2.mat.results.by.cohort.no.gpc   = summary.duohmm2.mat.results.by.cohort[,-2]
summary.nftools.mat.results.by.cohort.no.gpc= summary.nftools.mat.results.by.cohort[,-6]
summary.duohmm.mat.results.by.cohort.no.gpc = summary.duohmm.mat.results.by.cohort[,-4]
  
meta.fe.duohmm.i.n.f=rma.uni(yi=summary.duohmm2.mat.results.by.cohort.no.gpc[1,-ncol(summary.duohmm2.mat.results.by.cohort.no.gpc)],
sei=summary.duohmm2.mat.results.by.cohort.no.gpc[2,-ncol(summary.duohmm2.mat.results.by.cohort.no.gpc)],method="FE",weighted=T)

meta.fe.nftools=rma.uni(yi=summary.nftools.mat.results.by.cohort.no.gpc[1,-ncol(summary.nftools.mat.results.by.cohort.no.gpc)],
sei=summary.nftools.mat.results.by.cohort.no.gpc[2,-ncol(summary.nftools.mat.results.by.cohort.no.gpc)],method="FE",weighted=T)

meta.fe.duohmm=rma.uni(yi=summary.duohmm.mat.results.by.cohort.no.gpc[1,-ncol(summary.duohmm.mat.results.by.cohort.no.gpc)],
sei=summary.duohmm.mat.results.by.cohort.no.gpc[2,-ncol(summary.duohmm.mat.results.by.cohort.no.gpc)],method="FE",weighted=T)

meta.fe.duohmm.i.n.f.with.gpc=rma.uni(yi=summary.duohmm2.mat.results.by.cohort[1,-ncol(summary.duohmm2.mat.results.by.cohort)],
sei=summary.duohmm2.mat.results.by.cohort[2,-ncol(summary.duohmm2.mat.results.by.cohort)],method="FE",weighted=T)
meta.fe.nftools.with.gpc=rma.uni(yi=summary.nftools.mat.results.by.cohort[1,-ncol(summary.nftools.mat.results.by.cohort)],
sei=summary.nftools.mat.results.by.cohort[2,-ncol(summary.nftools.mat.results.by.cohort)],method="FE",weighted=T)
meta.fe.duohmm.with.gpc=rma.uni(yi=summary.duohmm.mat.results.by.cohort[1,-ncol(summary.duohmm.mat.results.by.cohort)],
sei=summary.duohmm.mat.results.by.cohort[2,-ncol(summary.duohmm.mat.results.by.cohort)],method="FE",weighted=T)



summary.duohmm2.pat.results.by.cohort.no.gpc   = summary.duohmm2.pat.results.by.cohort[,-2]
summary.nftools.pat.results.by.cohort.no.gpc= summary.nftools.pat.results.by.cohort[,-6]
summary.duohmm.pat.results.by.cohort.no.gpc = summary.duohmm.pat.results.by.cohort[,-3]
  
pat.meta.fe.duohmm.i.n.f=rma.uni(yi=summary.duohmm2.pat.results.by.cohort.no.gpc[1,-ncol(summary.duohmm2.pat.results.by.cohort.no.gpc)],
sei=summary.duohmm2.pat.results.by.cohort.no.gpc[2,-ncol(summary.duohmm2.pat.results.by.cohort.no.gpc)],method="FE",weighted=T)
pat.meta.fe.nftools=rma.uni(yi=summary.nftools.pat.results.by.cohort.no.gpc[1,-ncol(summary.nftools.pat.results.by.cohort.no.gpc)],
sei=summary.nftools.pat.results.by.cohort.no.gpc[2,-ncol(summary.nftools.pat.results.by.cohort.no.gpc)],method="FE",weighted=T)
pat.meta.fe.duohmm=rma.uni(yi=summary.duohmm.pat.results.by.cohort.no.gpc[1,-ncol(summary.duohmm.pat.results.by.cohort.no.gpc)],
sei=summary.duohmm.pat.results.by.cohort.no.gpc[2,-ncol(summary.duohmm.pat.results.by.cohort.no.gpc)],method="FE",weighted=T)

pat.meta.fe.duohmm.i.n.f.with.gpc=rma.uni(yi=summary.duohmm2.pat.results.by.cohort[1,-ncol(summary.duohmm2.pat.results.by.cohort)],
sei=summary.duohmm2.pat.results.by.cohort[2,-ncol(summary.duohmm2.pat.results.by.cohort)],method="FE",weighted=T)
pat.meta.fe.nftools.with.gpc=rma.uni(yi=summary.nftools.pat.results.by.cohort[1,-ncol(summary.nftools.pat.results.by.cohort)],
sei=summary.nftools.pat.results.by.cohort[2,-ncol(summary.nftools.pat.results.by.cohort)],method="FE",weighted=T)
pat.meta.fe.duohmm.with.gpc=rma.uni(yi=summary.duohmm.pat.results.by.cohort[1,-ncol(summary.duohmm.pat.results.by.cohort)],
sei=summary.duohmm.pat.results.by.cohort[2,-ncol(summary.duohmm.pat.results.by.cohort)],method="FE",weighted=T)
...
write.table(meta.summary,"/home/hilary/maternal_age_recombination/paper/summary_of_meta_analysis_results.with_new_QTR.txt",quote=F,sep="\t")

pdf("/home/hilary/maternal_age_recombination/paper/figures/with_new_QTR/box_plot_of_beta_Age_from_LMM_on_different_family_types.no_nkids_term.no_GPC_in_metaanalysis.pdf",
height=4,width=6,useDingbats=F)
mycols=c("black","blue","red","green","orange","red4","purple","lightblue","darkgreen","violetred2")
names(mycols)=c("CARL","FC","FVG","GPC","NTR","QTR370","QTR610","QTRCoreExome","VB","ORCADES")
scaling=0.05
my.offset=0.007
my.n = 11
par(oma=c(0,0,1,0),mar=c(5,4,2,1))
plot(1:my.n,rep(0,my.n),main="",ylim=c(-0.7,1.2),col=c(rep("white",my.n)),pch=19,xaxt="n",xlab="",ylab="",cex=0.5,xlim=c(1,my.n+0.5))
mtext(expression(beta["age"]),2,line=2.5)
mtext("Cohort",1,line=3.2)

axis(1,at=1:my.n,labels=FALSE,tick=F,cex.axis=0.5,las=2)
mylabels=c(gsub("duohmm.","",colnames(summary.duohmm.mat.results.by.cohort)[1:(ncol(summary.duohmm.mat.results.by.cohort)-1)]),"meta-analysis")
text(1:my.n, par("usr")[3] - 0.17, labels = mylabels, srt = 45, pos = 1, xpd = TRUE,cex=0.8)
...
abline(h=0)
xs = 1:(my.n - 1)
  names(xs) = colnames(summary.duohmm.mat.results.by.cohort)[1:(ncol(summary.duohmm.mat.results.by.cohort)-1)]
  ref = 142
  summary.nftools.mat.results.by.cohort=summary.nftools.mat.results.by.cohort[,c("FC","GPC","NTR","ORCADES","QTR370","QTR610","QTRCoreExome","VB","all")]
  sample.sizes=table(data1.mat.nftools$cohort)
print(sample.sizes)

my.n.nftools = 8
for(i in 1:my.n.nftools){
my.x=xs[colnames(summary.nftools.mat.results.by.cohort)[i]]
my.y=summary.nftools.mat.results.by.cohort[1,i]
offset=my.offset*sample.sizes[colnames(summary.nftools.mat.results.by.cohort)[i]]/ref
segments(x0=my.x,y0=summary.nftools.mat.results.by.cohort[1,i]-1.96*summary.nftools.mat.results.by.cohort[2,i],x1=my.x,
y1=summary.nftools.mat.results.by.cohort[1,i]+1.96*summary.nftools.mat.results.by.cohort[2,i],lty=1)
polygon(c(my.x-scaling,my.x-scaling,my.x+scaling,my.x+scaling),c(my.y-offset,my.y+offset,my.y+offset,my.y-offset),
col=mycols[colnames(summary.nftools.mat.results.by.cohort)[i]],border=mycols[colnames(summary.nftools.mat.results.by.cohort)[i]])
}
points(my.n,meta.fe.nftools$b,pch=19,cex=0.5)
segments(x0=my.n,y0=meta.fe.nftools$ci.lb,x1=my.n,y1=meta.fe.nftools$ci.ub)
...
offset=my.offset*sample.sizes[colnames(summary.duohmm2.mat.results.by.cohort)[i]]/ref
segments(x0=my.x,y0=summary.duohmm2.mat.results.by.cohort[1,i]-1.96*summary.duohmm2.mat.results.by.cohort[2,i],x1=my.x,
y1=summary.duohmm2.mat.results.by.cohort[1,i]+1.96*summary.duohmm2.mat.results.by.cohort[2,i],lty=2)
polygon(c(my.x-scaling,my.x-scaling,my.x+scaling,my.x+scaling),c(my.y-offset,my.y+offset,my.y+offset,my.y-offset),
col=mycols[colnames(summary.duohmm2.mat.results.by.cohort)[i]],border=mycols[colnames(summary.duohmm2.mat.results.by.cohort)[i]])
}
  points(my.n+0.2,meta.fe.duohmm.i.n.f$b,pch=19,cex=0.5)
segments(x0=my.n+0.2,y0=meta.fe.duohmm.i.n.f$ci.lb,x1=my.n+0.2,y1=meta.fe.duohmm.i.n.f$ci.ub,lty=2)
...
offset=my.offset*sample.sizes[colnames(summary.duohmm.mat.results.by.cohort)[i]]/ref
segments(x0=my.x,y0=summary.duohmm.mat.results.by.cohort[1,i]-1.96*summary.duohmm.mat.results.by.cohort[2,i],x1=my.x,
y1=summary.duohmm.mat.results.by.cohort[1,i]+1.96*summary.duohmm.mat.results.by.cohort[2,i],lty=4)
polygon(c(my.x-scaling,my.x-scaling,my.x+scaling,my.x+scaling),c(my.y-offset,my.y+offset,my.y+offset,my.y-offset),
col=mycols[colnames(summary.duohmm.mat.results.by.cohort)[i]],border=mycols[colnames(summary.duohmm.mat.results.by.cohort)[i]])
}
points(my.n+0.4,meta.fe.duohmm$b,pch=19,cex=0.5)
segments(x0=my.n+0.4,y0=meta.fe.duohmm$ci.lb,x1=my.n+0.4,y1=meta.fe.duohmm$ci.ub,lty=4)
...
meta.fe=rma.uni(yi=summary.duohmm2.mat.results.by.cohort[1,-ncol(summary.duohmm2.mat.results.by.cohort)],
sei=summary.duohmm2.mat.results.by.cohort[2,-ncol(summary.duohmm2.mat.results.by.cohort)],method="FE",weighted=T)
...
pdf("/home/hilary/maternal_age_recombination/paper/figures/with_new_QTR/scatterplots_of_duoHMM_crossovers_vs_age.informative_duos.pdf",height=6,width=15)
cohorts=c("CARL","FC","FVG","GPC","NTR","QTR370","QTR610","QTRCoreExome","VB","ORCADES")
...
for(c in 1:length(cohorts)){
    ...
    plot(data1.mat$age.at.birth[data1.mat$cohort!=cohorts[c]],data1.mat$nrec[data1.mat$cohort!=cohorts[c]],main=cohorts[c],xlab="maternal age at birth",
ylab="Number of crossovers",col=alpha("grey",0.3),pch=19,     xlim=range(data1.mat$age.at.birth),ylim=range(data1.mat$nrec),cex=0.5)
...
cohorts=c("FC", "GPC","NTR","QTR370", "QTR610", "QTRCoreExome","VB" ,"ORCADES")
pdf("/home/hilary/maternal_age_recombination/paper/figures/with_new_QTR/scatterplots_of_duoHMM_crossovers_vs_age.informative_nuc_fams.pdf",height=9,width=9)
par(mfrow=c(3,3))
for(c in 1:length(cohorts)){
    my.lme=summary(lme(nrec~age.at.birth,~1|as.factor(PARENT),data=data0.mat[data0.mat$cohort==cohorts[c],]))
    plot(data0.mat$age.at.birth[data0.mat$cohort!=cohorts[c]],data0.mat$nrec[data0.mat$cohort!=cohorts[c]],main=cohorts[c],xlab="maternal age at birth",ylab="Number of crossovers",
col=alpha("grey",0.4),pch=19,
...
dev.off()
  ...
  load("NFTOOLS_data_for_RSTAN.more_stringent.with_new_QTR.RData")
...
data1.mat$inf.nuc.fam2=data1.mat$CHILD %in% as.character(data1.mat.nftools$child)
  
data1.mat$point.type=19
data1.mat$col="black"

#data1.mat$point.type[!data1.mat$inf.nuc.fam]=3
  data1.mat$point.type[!data1.mat$inf.nuc.fam2]=3
#data1.mat$col[!data1.mat$inf.nuc.fam]="red"
  data1.mat$col[!data1.mat$inf.nuc.fam2]="red"

#pdf("/home/hilary/maternal_age_recombination/paper/figures/with_new_QTR/scatterplots_of_duoHMM_crossovers_vs_age.informative_duos_vs_informative_nuc_fams.pdf",height=8,width=16)
  pdf("/home/hilary/maternal_age_recombination/paper/figures/with_new_QTR/scatterplots_of_duoHMM_crossovers_vs_age.informative_duos_vs_duos_in_NFTOOLS.pdf",height=8,width=20)
cohorts=c("CARL","FC","FVG","GPC","NTR","QTR370","QTR610","QTRCoreExome","VB","ORCADES")

  par(mfrow=c(2,5),mar=c(2,2,2,2),cex=1,oma=c(2,2,3,2))
for(c in 1:length(cohorts)){
    my.lme=summary(lme(nrec~age.at.birth,~1|as.factor(PARENT),data=data1.mat[data1.mat$cohort==cohorts[c],]))
#    if(sum(data1.mat$cohort==cohorts[c] & data1.mat$inf.nuc.fam)>0){
        if(sum(data1.mat$cohort==cohorts[c] & data1.mat$inf.nuc.fam2)>0){
#        my.lme2=summary(lme(nrec~age.at.birth,~1|as.factor(PARENT),data=data1.mat[data1.mat$cohort==cohorts[c] & data1.mat$inf.nuc.fam,]))
                my.lme2=summary(lme(nrec~age.at.birth,~1|as.factor(PARENT),data=data1.mat[data1.mat$cohort==cohorts[c] & data1.mat$inf.nuc.fam2,]))
    }
    
    plot(data1.mat$age.at.birth[data1.mat$cohort==cohorts[c]],data1.mat$nrec[data1.mat$cohort==cohorts[c]],pch=data1.mat$point.type[data1.mat$cohort==cohorts[c]],cex=0.5,col=data1.mat$col[data1.mat$cohort==cohorts[c]],main=cohorts[c],
         xlab="",ylab="",     xlim=range(data1.mat$age.at.birth),ylim=c(20,80),cex.main=2,cex.axis=1.5,cex.lab=1.5)
    abline(a=my.lme$coefficients$fixed[1],b=my.lme$coefficients$fixed[2])
#    if(sum(data1.mat$cohort==cohorts[c] & data1.mat$inf.nuc.fam)>0){
        if(sum(data1.mat$cohort==cohorts[c] & data1.mat$inf.nuc.fam2)>0){
        abline(a=my.lme2$coefficients$fixed[1],b=my.lme2$coefficients$fixed[2],lty=2)
    }
    legend("topleft",c(paste0("= ",round(my.lme$coefficients$fixed[2],2)),paste0("= ",round(my.lme$tTable[2,5],3))))
#    if(sum(data1.mat$cohort==cohorts[c] & data1.mat$inf.nuc.fam)>0){
        if(sum(data1.mat$cohort==cohorts[c] & data1.mat$inf.nuc.fam2)>0){
        legend("topright",c(paste0("= ",round(my.lme2$coefficients$fixed[2],2)),paste0("= ",round(my.lme2$tTable[2,5],3))))
    }

}
    mtext("Supplementary Figure 4",3,outer=T,cex=2,padj=0.2,at=0.1,font=2,line=1.5)
    mtext("maternal age at birth",1,outer=T,cex=1.6,padj=0.8)
    mtext("Number of crossovers",2,outer=T,cex=1.6,padj=0.8,line=1.5)
...
pdf("/home/hilary/maternal_age_recombination/paper/figures/with_new_QTR/NFTOOLS_vs_duoHMM_counts.by_cohort.inform_nuc_fams_only.pdf",height=9,width=9)
par(mfrow=c(3,3),mar=c(2,2,2,2),cex=1,oma=c(2,2,3,2))
cohorts=unique(both$cohort)
for(i in 1:length(cohorts)){
    plot(x=jitter(both$Freq[both$cohort==cohorts[i]]),y=jitter(both$nrec[both$cohort==cohorts[i]]),col=alpha(both$col[both$cohort==cohorts[i]],0.5),xlab="",ylab="",pch=19,
main=cohorts[i],cex.axis=1,cex.main=1.5,cex.lab=1.5)
    abline(a=0,b=1)
...
cohort.list=read.delim("cohort_list.with_new_QTR.txt",header=F,stringsAsFactors=F)
pdf("/home/hilary/maternal_age_recombination/paper/figures/with_new_QTR/FigureS2_qqplots_duoHMM.informative_duos_only.showing_filtering.pdf",height=16,width=12,useDingbats=F)
...
pdf("/home/hilary/maternal_age_recombination/paper/figures/with_new_QTR/qqplots_duoHMM.double_xovers_within_X_SNPs_removed.showing_effect_of_family_type.pdf",height=16,width=12,useDingbats=F)
...
#legend("topleft",c("3 kids, both parents","3 kids, one parent","2 kids, both parents","2 kids, one parent","1 kid, both parents",
#"1 kid, one parent","3 generations, both parents","3 generations, one parent"), pch=mypch,col=mycols,cex=0.8,pt.bg=mycols)
#plot(1,1,col="white",xaxt="n",yaxt="n", bty='n')
for(i in 1:nrow(cohort.list)){
    mydir=cohort.list[i,1]
    cohort=cohort.list[i,2]
    ...
    if(nrow(subset(rec.flt1.informative.2gen.2parents,sex="Male"))>0){points(jitter(qqr(subset(rec.flt1.informative.2gen.2parents,sex=="Male")$nrec,malesize,makeplot=0)),
pch=mypch[1],col=mycols[1],bg=mycols[1],cex=0.5)}
    if(nrow(subset(rec.flt1.informative.2gen.1parent,sex=="Male"))>0){points(jitter(qqr(subset(rec.flt1.informative.2gen.1parent,sex=="Male")$nrec,malesize,makeplot=0)),
pch=mypch[2],col=mycols[2],bg=mycols[2],cex=0.5)}
    if(nrow(subset(rec.flt1.noninf.2kids.2gen.2parents,sex=="Male"))>0){points(jitter(qqr(subset(rec.flt1.noninf.2kids.2gen.2parents,sex=="Male")$nrec,malesize,makeplot=0)),
pch=mypch[3],col=mycols[3],bg=mycols[3],cex=0.5)}
    if(nrow(subset(rec.flt1.noninf.2kids.2gen.1parent,sex="Male"))>0){points(jitter(qqr(subset(rec.flt1.noninf.2kids.2gen.1parent,sex=="Male")$nrec,malesize,makeplot=0)),
pch=mypch[4],col=mycols[4],bg=mycols[4],cex=0.5)}
    if(nrow(subset(rec.flt1.noninf.1kid.2gen.2parents,sex=="Male"))>0){points(jitter(qqr(subset(rec.flt1.noninf.1kid.2gen.2parents,sex=="Male")$nrec,malesize,makeplot=0)),
pch=mypch[5],col=mycols[5],bg=mycols[5],cex=0.5)}
    if(nrow(subset(rec.flt1.noninf.1kid.2gen.1parent,sex=="Male"))>0){points(jitter(qqr(subset(rec.flt1.noninf.1kid.2gen.1parent,sex=="Male")$nrec,malesize,makeplot=0)),
pch=mypch[6],col=mycols[6],bg=mycols[6],cex=0.5)}
    if(nrow(subset(rec.flt1.informative.3gen.2parents,sex=="Male"))>0){points(jitter(qqr(subset(rec.flt1.informative.3gen.2parents,sex=="Male")$nrec,malesize,makeplot=0)),
pch=mypch[7],col=mycols[7],bg=mycols[7],cex=0.5)}
    if(nrow(subset(rec.flt1.informative.3gen.1parent,sex=="Male"))>0){points(jitter(qqr(subset(rec.flt1.informative.3gen.1parent,sex=="Male")$nrec,malesize,makeplot=0)),
pch=mypch[8],col=mycols[8],bg=mycols[8],cex=0.5)}

    tmp <- qqr(subset(rec.flt1,sex=="Female")$nrec,femalesize,"white",title=paste(argv[5]," maternal"),limits=range(0,76),xlowerlimit=20)
    if(nrow(subset(rec.flt1.informative.2gen.2parents,sex="Female"))>0){points(jitter(qqr(subset(rec.flt1.informative.2gen.2parents,sex=="Female")$nrec,femalesize,makeplot=0)),
pch=mypch[1],col=mycols[1],bg=mycols[1],cex=0.5)}
    if(nrow(subset(rec.flt1.informative.2gen.1parent,sex=="Female"))>0){points(jitter(qqr(subset(rec.flt1.informative.2gen.1parent,sex=="Female")$nrec,femalesize,makeplot=0)),
pch=mypch[2],col=mycols[2],bg=mycols[2],cex=0.5)}
    if(nrow(subset(rec.flt1.noninf.2kids.2gen.2parents,sex=="Female"))>0){points(jitter(qqr(subset(rec.flt1.noninf.2kids.2gen.2parents,sex=="Female")$nrec,femalesize,makeplot=0)),
pch=mypch[3],col=mycols[3],bg=mycols[3],cex=0.5)}
    if(nrow(subset(rec.flt1.noninf.2kids.2gen.1parent,sex="Female"))>0){points(jitter(qqr(subset(rec.flt1.noninf.2kids.2gen.1parent,sex=="Female")$nrec,femalesize,makeplot=0)),
pch=mypch[4],col=mycols[4],bg=mycols[4],cex=0.5)}
    if(nrow(subset(rec.flt1.noninf.1kid.2gen.2parents,sex=="Female"))>0){points(jitter(qqr(subset(rec.flt1.noninf.1kid.2gen.2parents,sex=="Female")$nrec,femalesize,makeplot=0)),
pch=mypch[5],col=mycols[5],bg=mycols[5],cex=0.5)}
    if(nrow(subset(rec.flt1.noninf.1kid.2gen.1parent,sex=="Female"))>0){points(jitter(qqr(subset(rec.flt1.noninf.1kid.2gen.1parent,sex=="Female")$nrec,femalesize,makeplot=0)),
pch=mypch[6],col=mycols[6],bg=mycols[6],cex=0.5)}
    if(nrow(subset(rec.flt1.informative.3gen.2parents,sex=="Female"))>0){points(jitter(qqr(subset(rec.flt1.informative.3gen.2parents,sex=="Female")$nrec,femalesize,makeplot=0)),
pch=mypch[7],col=mycols[7],bg=mycols[7],cex=0.5)}
    if(nrow(subset(rec.flt1.informative.3gen.1parent,sex=="Female"))>0){points(jitter(qqr(subset(rec.flt1.informative.3gen.1parent,sex=="Female")$nrec,femalesize,makeplot=0)),
pch=mypch[8],col=mycols[8],bg=mycols[8],cex=0.5)}
}
    mtext("Expected recombinations genome-wide",1,outer=T,cex=1.6,padj=0.8)
    mtext("Observed recombinations genome-wide",2,outer=T,cex=1.6,padj=-0.5)
...
malesize <- sum(male.lengths)
femalesize <- sum(female.lengths)
pdf(paste0("/home/hilary/maternal_age_recombination/paper/figures/with_new_QTR/NFTOOLS-qq.pdf"),width=12,height=12,useDingbats=F)
...
load("/well/donnelly/hilary/maternal_age_and_recombination/duoHMM_data_for_RSTAN.more_stringent.with_new_QTR.RData")
outdir="/home/hilary/maternal_age_recombination/paper/figures/with_new_QTR/"
mycols=c("black","blue","red","green","orange","red4","purple","red2","darkgreen","violetred2","yellow","skyblue")
names(mycols)=c("CARL","FC","FVG","GPC","NTR","QTR370","QTR610","QTRCoreExome","VB","ORCADES","VIS","KORCULA")
...
for(i in 1:length(mycols)){
  ...
  hist(all.data[all.data$sex=="Female" & all.data$cohort==names(mycols)[i],"age.at.birth"],main=paste0(names(mycols)[i]," maternal"),xlab="age at birth",lwd=2,freq=F ,
           xlim=range(all.data[all.data$sex=="Female","age.at.birth"]),breaks=20,cex.main=2,cex.lab=2,cex.axis=2)
curve(dnorm(x,mean=mean(all.data[all.data$sex=="Female" & all.data$cohort==names(mycols)[i],"age.at.birth"]),sd=sd(all.data[all.data$sex=="Female" 
& all.data$cohort==names(mycols)[i],"age.at.birth"])),lty=2,col=mycols[i],
            add=T ,lwd=3)
      hist(all.data[all.data$sex=="Male" & all.data$cohort==names(mycols)[i],"age.at.birth"],main=paste0(names(mycols)[i]," paternal"),xlab="age at birth",lwd=2,freq=F ,
           xlim=range(all.data[all.data$sex=="Male","age.at.birth"]),breaks=20,cex.main=2,cex.lab=2,cex.axis=2)
curve(dnorm(x,mean=mean(all.data[all.data$sex=="Male" & all.data$cohort==names(mycols)[i],"age.at.birth"]),sd=sd(all.data[all.data$sex=="Male" 
& all.data$cohort==names(mycols)[i],"age.at.birth"])),lty=2,col=mycols[i],
            add=T ,lwd=3)
}
dev.off()
