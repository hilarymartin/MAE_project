...
compare.NFTOOLS.to.duoHMM.v2(NTR.data,"NTR/duoHMM_results/NTR_v2_minus_MZs.all.post_MERLIN.max_0.05_missing.generr_removed.recombination_count.p_0.5.annotated.double_xovers_within_X_SNPs_removed.txt",mydir,"NTR_v2",0.5)
