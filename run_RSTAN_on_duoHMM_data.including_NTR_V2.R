...
#pdf("model1.tausq.sigmasq.pdf")
#my.density=kde2d(mysim$tausq,mysim$sigmasq <- m,h=c(1,1))
#filled.contour(my.density,xlab="tausq",ylab="sigmasq_m",main="bandwith=1")
#dev.off()
...
#                                         init=list(list(sigmasq_m=0.05,beta_Age=rep(0,8),beta_Cohort=rep(0,7),tausq=19,mu_m=31,a0=rnorm(n=data1.mat2$I,mean=31,sd=sqrt(0.05))))))
    ...
    model1.mat <- sflist2stanfit(model1.mat.list)
                                ...
                                print(model1.mat,pars=c("beta_Age","beta_Cohort","tausq","sigmasq_m","mu_m"),digits=4)
                                        #    save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model1.mat.initialized_close_to_MAP.RData")
                                save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model1.mat.initialized_at_MAP.RData")
                                        #    save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model1.mat.RData")
...
if(FALSE){
    ...
    my.ylim=7
    pdf("RSTAN_output_with_NTR_v2/model1.maternal.posteriors.beta_Age.pdf",height=5,width=5)
    ...
    save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model1.pat.RData")
    ...
    my.ylim=15
    pdf("RSTAN_output_with_NTR_v2/model1.paternal.posteriors.beta_Age.pdf",height=5,width=5)
    for(i in 1:ncol(mysim$beta_Age)){
        if(i==1){
            plot(density(mysim$beta_Age[,i]),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
        }else {
...
#common age effect
    ...
    save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model1.2.mat.RData")
    ...
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T)
    my.ylim=12
    pdf("RSTAN_output_with_NTR_v2/model1.2.maternal.posteriors.beta_Age.pdf",height=5,width=5)
    ...
    save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model1.2.pat.RData")
    ...
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T)
    my.ylim=12
    pdf("RSTAN_output_with_NTR_v2/model1.2.paternal.posteriors.beta_Age.pdf",height=5,width=5)
...
#cohort-specific age effects, but drawn from N(beta_global,sigmasq_global); with cohort effect
    ...
    save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model1.3.mat.RData")
    ...
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T)
    pdf("RSTAN_output_with_NTR_v2/model1.3.maternal.posteriors.beta_Age.pdf",height=5,width=5)
    my.ylim=7
    for(i in 1:ncol(mysim$beta_Age)){
        if(i==1){
            plot(density(mysim$beta_Age[,i]),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
    ...
    dev.off()
    pdf("RSTAN_output_with_NTR_v2/model1.3.maternal.posteriors.sigmasq_global.pdf",height=5,width=5)
    ...
    save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model1.3.pat.RData")
    
    mysim<-extract(model1.3.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T)
    my.ylim=14
    pdf("RSTAN_output_with_NTR_v2/model1.3.paternal.posteriors.beta_Age.pdf",height=5,width=5)
    for(i in 1:ncol(mysim$beta_Age)){
        if(i==1){
            plot(density(mysim$beta_Age[,i]),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
        }else {
    ...
    dev.off()
    pdf("RSTAN_output_with_NTR_v2/model1.3.paternal.posteriors.sigmasq_global.pdf",height=5,width=5)
    plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
    dev.off()
...
#cohort-specific age effects, but drawn from N(beta_global,sigmasq_global); no cohort effect
    ...
    save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model1.4.mat.RData")
    ...
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T)
    my.ylim=12
    pdf("RSTAN_output_with_NTR_v2/model1.4.maternal.posteriors.beta_Age.pdf",height=5,width=5)
    ...
    dev.off()
    pdf("RSTAN_output_with_NTR_v2/model1.4.maternal.posteriors.sigmasq_global.pdf",height=5,width=5)
    plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
    dev.off()
    ...
    save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model1.4.pat.RData")
...
cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T)
my.ylim=15
pdf("RSTAN_output_with_NTR_v2/model1.4.paternal.posteriors.beta_Age.pdf",height=5,width=5)
...
dev.off()
pdf("RSTAN_output_with_NTR_v2/model1.4.paternal.posteriors.sigmasq_global.pdf",height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()
...
save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model2.mat.RData")
...
my.ylim=8
pdf("RSTAN_output_with_NTR_v2/model2.maternal.posteriors.beta_Age.pdf",height=5,width=5)
...
dev.off()
    ...
    save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model2.pat.RData")
...
my.ylim=15
pdf("RSTAN_output_with_NTR_v2/model2.paternal.posteriors.beta_Age.pdf",height=5,width=5)
...
#common age effect
   ...
   model2.2.mat.list <- mclapply(1:4, mc.cores = 4,function(i) stan(fit = model2.2.mat.compiled, data = data1.2.mat2,chains = 1, chain_id = i,iter=10000,pars=c("beta_Age","beta_Cohort","tausq","mu_m")))
    ...
    save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model2.2.mat.RData")
...
cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_2.txt",header=T)
pdf("RSTAN_output_with_NTR_v2/model2.2.maternal.posteriors.beta_Age.pdf",height=5,width=5)
my.ylim=12
...
save.image("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model2.2.pat.RData")
...
cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_2.txt",header=T)
pdf("RSTAN_output_with_NTR_v2/model2.2.paternal.posteriors.beta_Age.pdf",height=5,width=5)
my.ylim=12
...
if(argv[1] ==25){
 ...
 #   save(model3.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.model3.adjusted_priors.all_chains.mat.including_alpha.RData"))
 #   print(model3.mat,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.model3.adjusted_priors.all_chains.mat.including_alpha.RData")
    mysim<-extract(model3.mat,permuted=T)
    parent="adjusted_priors.maternal"
    cohort.codes=read.delim("RSTAN_output_with_NTR_v2/key_for_maternal_cohorts_to_include_in_model_3.NTR_v2.txt",header=T,stringsAsFactors=F)
...
#    save(model3.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.model3.adjusted_priors.all_chains.pat.including_alpha.RData"))
#    print(model3.pat,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.model3.adjusted_priors.all_chains.pat.including_alpha.RData")
    mysim<-extract(model3.pat,permuted=T)
    parent="adjusted_priors.paternal"
    cohort.codes=read.delim("RSTAN_output_with_NTR_v2/key_for_paternal_cohorts_to_include_in_model_3.NTR_v2.txt",header=T,stringsAsFactors=F)
...
if(argv[1]==25|argv[1]==26){
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model3.",parent,".posteriors.beta_Age.pdf"),height=5,width=5)
    my.ylim=32
    for(i in 1:ncol(mysim$beta_Age)){
        if(i==1){
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model3.",parent,".posteriors.p.pdf"),height=5,width=5)
...
dev.off()
    pdf(paste0("RSTAN_output_with_NTR_v2/model3.",parent,".posteriors.sigmasq_global.pdf"),height=5,width=5)
      plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
    dev.off()

    pdf(paste0("RSTAN_output_with_NTR_v2/model3.",parent,".posteriors.omega.pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model3.",parent,".posteriors.mu_m.pdf"),height=5,width=5)
...
#save(model3.2.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.model3.2.adjusted_priors.all_chains.mat.including_alpha.RData"))
#print(model3.2.mat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.model3.2.adjusted_priors.all_chains.mat.including_alpha.RData")
...
#    save(model3.2.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.model3.2.adjusted_priors.all_chains.pat.including_alpha.RData"))
#    print(model3.2.pat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.model3.2.adjusted_priors.all_chains.pat.including_alpha.RData")
...
if(argv[1] %in% c(27,28)){
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model3.2.",parent,".posteriors.beta_Age.pdf"),height=5,width=5)
...
#                 lwd=c(rep(2,length(mycols)),3,2,2,2,2,1),cex=0.5)
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model3.2.",parent,".posteriors.p.pdf"),height=5,width=5)
    for(i in 1:ncol(mysim$p_by_cohort)){
        mylabels=c(paste(c("informative, 2 generations","informative, 3 generations","uninformative, 2 kids"),"both parents",sep=", "),paste(c("informative, 2 generations","informative, 3 generations","uninformative, 2 kids"),"1 parent",sep=", "))
        names(mylabels)=c("infor.2gen.2parents","infor.3gen.2parents","noninfor.2kids.2gen.2parents","infor.2gen.1parent","infor.3gen.1parent","noninfor.2kids.2gen.1parent")
        sample.size= sum(data2.mat$cohort.family.type==cohort.codes[cohort.codes[,1]==i,"Cohort"])
...
library(pscl)
    pdf(paste0("RSTAN_output_with_NTR_v2/model3.2.",parent,".posteriors.sigmasq_m.pdf"),height=5,width=5)
      plot(density(mysim$sigmasq_m),xlab="sigmasq_m",main="Posterior for sigmasq_m",lwd=2)
    lines(rigamma(x,5,5),lty=2,lwd=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    
    dev.off()
    
    pdf(paste0("RSTAN_output_with_NTR_v2/model3.2.",parent,".posteriors.omega.pdf"),height=5,width=5)
    plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
    lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
    
    pdf(paste0("RSTAN_output_with_NTR_v2/model3.2.",parent,".posteriors.mu_m.pdf"),height=5,width=5)
    plot(density(mysim$mu_m),main="Posterior for mu_m",lwd=2,xlab="mu_m")
    curve(dnorm(x,36,sqrt(6 )),lwd=2,lty=2,add=T)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
...
if(argv[1]==29){
 ...
 print(model1.6.mat,pars=c("beta_Age","beta_global","sigmasq_global","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
 #    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.all_chains.mat.including_alpha.RData")

#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
#}
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
   ...
   mean_alpha_prior=27
    ...
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    #load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.all_chains.pat.including_alpha.RData")
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="paternal"
}

pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.mu_m.pdf"),height=5,width=5)
...
library(pscl)
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
    lines(density(rigamma(10000,3,0.5)),lwd=2,lty=2)
legend("topright",c("posterior","prior"),lty=c(1,2),lwd=c(2,2))
dev.off()
pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.tausq.pdf"),height=5,width=5)
...
print(model1.7.mat,pars=c("beta_Age","beta_global","sigmasq_global","beta_Cohort","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.7.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.7.all_chains.mat.including_alpha.RData"))
#load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.7.all_chains.mat.including_alpha.RData")
...
print(model1.7.pat,pars=c("beta_Age","beta_global","sigmasq_global","beta_Cohort","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.7.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.7.all_chains.pat.including_alpha.RData"))
    #load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.7.all_chains.pat.including_alpha.RData")
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.7.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
for(i in 1:ncol(mysim$beta_Age)){
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.7.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()
}
...
print(model1.5.mat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.all_chains.mat.including_alpha.RData"))
    #load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.all_chains.mat.including_alpha.RData")
...
print(model1.5.pat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.all_chains.pat.including_alpha.RData"))
    #load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.all_chains.pat.including_alpha.RData")
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
my.ylim=55
for(i in 1:ncol(mysim$beta_Age)){
    if(i==1){
        plot(density(mysim$beta_Age[,i]),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()
}
...
if(argv[1]==35){
    ...
    model1.5.mat <- sflist2stanfit(model1.5.mat.list)
print(model1.5.mat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
   save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.different_link.all_chains.mat.including_alpha.RData"))
    #load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.different_link.all_chains.mat.including_alpha.RData")
    ...
    model1.5.pat <- sflist2stanfit(model1.5.pat.list)
 print(model1.5.pat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.different_link.all_chains.pat.including_alpha.RData"))
#load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.different_link.all_chains.pat.including_alpha.RData")
    mysim<-extract(model1.5.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="paternal"
}
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.different_link.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.different_link.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()
}
...
if(argv[1]==37){
    ...
    model1.5.mat <- sflist2stanfit(model1.5.mat.list)
 print(model1.5.mat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.different_link.weaker_priors.all_chains.mat.including_alpha.RData"))
#load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.different_link.weaker_priors.all_chains.mat.including_alpha.RData")
...
#    
print(model1.5.pat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.different_link.weaker_priors.all_chains.pat.including_alpha.RData"))
#load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.different_link.weaker_priors.all_chains.pat.including_alpha.RData")
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.different_link.weaker_priors.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.different_link.weaker_priors.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()
}
...
if(argv[1]==39){
    ...
    save(model1.3.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.3.weaker_priors_on_age_effect.all_chains.mat.including_alpha.RData"))
#    #load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.3.weaker_priors_on_age_effect.all_chains.mat.including_alpha.RData")
    ...
    save(model1.3.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.3.weaker_priors_on_age_effect.all_chains.pat.including_alpha.RData"))
#    #load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.3.weaker_priors_on_age_effect.all_chains.pat.including_alpha.RData")
    mysim<-extract(model1.3.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="paternal"
}

pdf(paste0("RSTAN_output_with_NTR_v2/model1.3.weaker_priors_on_age_effect.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
for(i in 1:ncol(mysim$beta_Age)){
if(myname=="maternal"){    my.ylim=7}else {my.ylim=12}
if(i==1){
    plot(density(mysim$beta_Age[,i]),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.3.weaker_priors_on_age_effect.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()
...
#    model1.3.mat <- sflist2stanfit(model1.3.mat.list)
#    print(model1.3.mat,pars=c("beta_Age","beta_global","sigmasq_global","beta_Cohort","tausq","sigmasq_m","mu_m"),digits=4)
#    save(model1.3.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.3.uniform_prior_on_sigmasq_m.all_chains.mat.including_alpha.RData"))
   load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.3.uniform_prior_on_sigmasq_m.all_chains.mat.including_alpha.RData")
   mysim<-extract(model1.3.mat,permuted=T)
   cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T)
   myname="maternal"
} else {
   ...
   # model1.3.pat <- sflist2stanfit(model1.3.pat.list)
   # print(model1.3.pat,pars=c("beta_Age","beta_global","sigmasq_global","beta_Cohort","tausq","sigmasq_m","mu_m"),digits=4)
   # save(model1.3.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.3.uniform_prior_on_sigmasq_m.all_chains.pat.including_alpha.RData"))
load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.3.uniform_prior_on_sigmasq_m.all_chains.pat.including_alpha.RData")
    mysim<-extract(model1.3.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="paternal"
}

pdf(paste0("RSTAN_output_with_NTR_v2/model1.3.uniform_prior_on_sigmasq_m.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
for(i in 1:ncol(mysim$beta_Age)){
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.3.uniform_prior_on_sigmasq_m.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()

pdf(paste0("RSTAN_output_with_NTR_v2/model1.3.uniform_prior_on_sigmasq_m.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_m),xlab="sigmasq_m",main="Posterior for sigmasq_m",lwd=2)
dev.off()
...
#    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.RData"))
#    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,
                             ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
#}
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
                                        # load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.RData")
# load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="maternal"
} else {
...
#     if(FALSE){
    ...
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
     save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
#    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
#    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.RData")
#}
#     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
#     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="paternal"
}

pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".traceplots.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    my.ylim=100
#    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
...
#       legend("topright",c("Adam","decode","Hutterites","Julie"),lty=c(2,3,4,4),lwd=2,col=c("black","black","black","grey"),cex=0.5)
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
#//        curve(dnorm(x,mean_alpha_prior,sqrt(5)),add=T,lwd=3,lty=2)
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.17
        my.xlim=100
    }else {
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
#    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.all_chains.mat.including_alpha.RData")
}
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="maternal"
} else {
    ...
    if(FALSE){
        ...
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
                                        #    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.all_chains.pat.including_alpha.RData")
}
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.5.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="paternal"
}
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.4.",myname,".posteriors.beta_Age.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
abline(v=0,lwd=2)
dev.off()

pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.4.",myname,".posteriors.mu_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
library(pscl)
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.4.",myname,".posteriors.sigmasq_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.4.",myname,".posteriors.omega.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
...
#    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors.all_chains.mat.including_alpha.RData"))
#        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors.v4.all_chains.mat.including_alpha.RData"))
#     load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors.all_chains.mat.including_alpha.RData")
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors.v4.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==55){
        myname="uniform_priors_on_beta_Age.maternal"
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.mat.including_alpha.RData"))
#               load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==57){
        myname="uniform_priors_on_mu_m_cohort.maternal"
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.mat.including_alpha.RData"))
 #       load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==59){
        myname="uniform_priors_on_tau.maternal"
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.mat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==61){
        myname="uniform_priors_on_sigma_m.maternal"
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.mat.including_alpha.RData"))
 #       load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.mat.including_alpha.RData"))
    }
...
#}
    ...
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
                                        #    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors.all_chains.pat.including_alpha.RData")
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==56){
        myname="uniform_priors_on_beta_Age.paternal"
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==58){
        myname="uniform_priors_on_mu_m_cohort.paternal"
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==60){
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.pat.including_alpha.RData"))
        myname="uniform_priors_on_tau.paternal"
    }
    if(argv[1]==62){
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.pat.including_alpha.RData"))
...
#pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.uniform_priors.v4.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
...
#    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.uniform_priors.v4.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
        pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
        if(argv[1] %in% c(47,55,57,59,61)){
        my.ylim=0.6
        my.xlim=c(32,46)
    }else {
    ...
    dev.off()
   library(pscl)
#    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.uniform_priors.v4.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
        pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
        if(argv[1] %in% c(47,55,57,59,61)){
        my.ylim=0.2
        my.xlim=100
    }else {
...
#    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.uniform_priors.v4.",myname,".posteriors.tausq.pdf"),height=5,width=5)
        pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.tausq.pdf"),height=5,width=5)
...
if(FALSE){
   model1.5.mat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.5.4.uniform_priors.stan",data=data1.mat2,iter=10000,chains=0)
    ...
    model1.5.mat <- sflist2stanfit(model1.5.mat.list)
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.uniform_priors.v4.all_chains.mat.including_alpha.RData"))
}
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.uniform_priors.v4.all_chains.mat.including_alpha.RData"))
#    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.uniform_priors.all_chains.mat.including_alpha.RData")
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.uniform_priors.all_chains.mat.including_alpha.RData"))
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="maternal"
} else {
    ...
    if(FALSE){
        ...
        model1.5.pat <- sflist2stanfit(model1.5.pat.list)
        print(model1.5.pat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
                                        #    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.uniform_priors.all_chains.pat.including_alpha.RData")
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.uniform_priors.all_chains.pat.including_alpha.RData"))
    }
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.4.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
    mysim<-extract(model1.5.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="paternal"
}
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.4.uniform_priors.v4.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
abline(v=0,lwd=2)
dev.off()


pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.4.uniform_priors.v4.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
if(myname=="maternal"){
    my.ylim=1.7
} else {
    my.ylim=1.7
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.4.uniform_priors.v4.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=1
        my.xlim=10
    }else {
...
dev.off()
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.5.4.uniform_priors.v4.",myname,".posteriors.omega.pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
...
if(FALSE){
    ...
    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".RData"))

# load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".RData"))
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="maternal"
} else {
 ...
 if(FALSE){
    ...
    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas.df_",df.alpha,".RData"))
}
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas.df_",df.alpha,".RData"))
#    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.RData")
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T)
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.beta_Age.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    if(myname=="maternal"){
    ...
    dev.off()
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.mu_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.sigmasq_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.tausq.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),xlab="tausq",main="Posterior for tausq",lwd=2)
    lines(density(rigamma(10000,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
...
#### Model 1.62 -- common beta_Age for all cohorts; N(mu_cohort,sigmasq_m_cohort); sigmasq_m_cohort drawn independently from IG for each cohort
    ...
    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
 #   save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".RData"))
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".RData"))
#}
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".RData"))
# load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="maternal"
...
# if(FALSE){
    ...
    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
#    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas_and_Y.df_",df.alpha,".RData"))
         save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas_and_Y.df_",df.alpha,".RData"))
#    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.RData")
#}
#     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas_and_Y.df_",df.alpha,".RData"))
#     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T)
    myname="paternal"
...
pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    if(myname=="maternal"){
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){my.ylim=0.6}else {my.ylim=0.7}
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    legend("topright",c(as.character(cohort.codes[order(cohort.codes[,1]),2]),"prior"),col=c(mycols[as.character(cohort.codes[,2])],"black"),lty=c(rep(1,nrow(cohort.codes)),2),lwd=c(rep(2,nrow(cohort.codes)),3),cex=0.5)
    dev.off()
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),xlab="tausq",main="Posterior for tausq",lwd=2)
    lines(density(rigamma(10000,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
...
###fit model to adjusted counts y_adj~N(beta_Age * age_adj + beta_nkids*nkids,tausq_cohort)
    ...
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T) #should be model 1 since we're only including families with >1 kid
    if(FALSE){
                                        #common age effect
    ...
    save(model2.3.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model2.3.",myname,".RData"))
}
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model2.3.",myname,".RData"))
    ...
    save(model2.3.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model2.3.",myname,".RData"))
}
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model2.3.",myname,".RData"))
...
pdf(paste("RSTAN_output_with_NTR_v2/model2.3.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
my.ylim=12
plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
        abline(v=0,lwd=2)
    if(argv[1]==63){
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model2.3.",myname,".posteriors.beta_nkids.pdf"),height=5,width=5)
...
library(pscl)
pdf(paste0("RSTAN_output_with_NTR_v2/model2.3.",myname,".posteriors.tausq.pdf"),height=5,width=5)
    my.ylim=0.75
...
if(FALSE){
    ...
    save(model2.4.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model2.4.",myname,".RData"))
}
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model2.4.",myname,".RData"))
...
if(FALSE){
    ...
    save(model2.4.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model2.4.",myname,".RData"))
}
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/running_RSTAN.model2.4.",myname,".RData"))
...
pdf(paste("RSTAN_output_with_NTR_v2/model2.4.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
my.ylim=12
plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
if(argv[1]==65){
        abline(v=0,lwd=2)
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model2.4.",myname,".posteriors.beta_nkids.pdf"),height=5,width=5)
    plot(density(mysim$beta_nkids),xlim=range(mysim$beta_Age),xlab="beta_nkids",main="Posterior for beta_nkids",lwd=2)
    curve(dnorm(x,0,sigmasq_beta_nkids),lty=2,lwd=2,add=T)
    abline(v=0,lwd=2)
    legend("topleft",c("posterior","prior"),lwd=2,lty=c(1,2))
...
library(pscl)
    pdf(paste0("RSTAN_output_with_NTR_v2/model2.4.",myname,".posteriors.tausq.pdf"),height=5,width=5)
...
##    mean_alpha_prior=38
    ...
    print(model1.6.mat,pars=c("beta_Age","beta_Agesq","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.with_agesq_term.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.with_agesq_term.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,
                ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T)
...
#       legend("topright",c("Adam","decode","Hutterites","Julie"),lty=c(2,3,4,4),lwd=2,col=c("black","black","black","grey"),cex=0.5)
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/model1.6.2.",myname,".posteriors.beta_Agesq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
#        model1.6.mat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.8.stan",data=data1.mat2,iter=10000,chains=0)
 ...
 #          model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data1.mat2,chains = 1, chain_id = i,iter=10000,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0","beta_global","sigmasq_global")))
            cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T)
  #         model1.6.mat <- sflist2stanfit(model1.6.mat.list)
 #       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.",myname,".all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    }
    if(argv[1]==73){
       # model1.6.mat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.8.2.stan",data=data0.mat2,iter=10000,chains=0)
       # model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data0.mat2,chains = 1, chain_id = i,iter=10000,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0")))
        myname="model1.8.2.maternal.informative_nuc_fams_only"
        cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.informative_nuclear_families_only.txt",header=T)
    }
    if(argv[1]==75){
   #    model1.6.mat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.8.stan",data=data0.mat2,iter=10000,chains=0)
   #        model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data0.mat2,chains = 1, chain_id = i,iter=10000,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0","beta_global","sigmasq_global")))
 ...
 #   model1.6.mat <- sflist2stanfit(model1.6.mat.list)
 load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.",myname,".all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",
...
#}
 ...
 #   }
  #  data1.pat2$cohort_by_family = cohort_by_family
     ...
     if(argv[1] ==74){
         #model1.6.pat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.8.2.stan",data=data0.pat2,iter=10000,chains=0)
         myname="model1.8.2.paternal.informative_nuc_fams_only"
         #model1.6.pat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.pat.compiled, data = data0.pat2,chains = 1, chain_id = i,iter=10000,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0")))
         cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.informative_nuclear_families_only.txt",header=T)
     }
     if(argv[1]==76){
         #model1.6.pat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.8.stan",data=data0.pat2,iter=10000,chains=0)
  ...
  #  model1.6.pat <- sflist2stanfit(model1.6.pat.list)
     ...
     #save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.",myname,".all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.",myname,".all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
      print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
    mysim<-extract(model1.6.pat,permuted=T)
 }

pdf(paste0("RSTAN_output_with_NTR_v2/",myname,".traceplots.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    traceplot(model1.6.mat,pars=c("beta_Age"),window=c(10^2,10^4))
    traceplot(model1.6.mat,pars=c("mu_m"),window=c(10^2,10^4))
    traceplot(model1.6.mat,pars=c("sigmasq_m"),window=c(10^2,10^4))
    traceplot(model1.6.mat,pars=c("tausq"),window=c(10^2,10^4))
...
pdf(paste0("RSTAN_output_with_NTR_v2/",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    my.ylim=100
#    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
...
#       legend("topright",c("Adam","decode","Hutterites","Julie"),lty=c(2,3,4,4),lwd=2,col=c("black","black","black","grey"),cex=0.5)
    ...
    pdf(paste0("RSTAN_output_with_NTR_v2/",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    ...
    library(pscl)
        pdf(paste0("RSTAN_output_with_NTR_v2/",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    plot(density(mysim$sigmasq_m),xlab="sigmasq_m",main="Posterior for sigmasq_m",lwd=2)
    lines(density(rigamma(10000,sigmasq_m_alpha,sigmasq_m_beta)),lwd=3,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()

    pdf(paste0("RSTAN_output_with_NTR_v2/",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),lwd=2,main="Posterior for tausq",xlab="tausq")
    lines(density(rigamma(10000,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lty=c(1,2),lwd=2)
    dev.off()
...
cat("Model 3, uniform_p_priors, with adjusted priors\n")
    if(argv[1] ==43){
        ...
        model3.mat.list <- mclapply(1:4, mc.cores = 4,function(i) stan(fit = model3.mat.compiled, data = data2.mat2,chains = 1, chain_id = i,iter=10000,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0")))
        model3.mat <- sflist2stanfit(model3.mat.list)
        save(model3.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.model3.uniform_p_priors.all_chains.mat.including_alpha.RData"))
        cohort.codes=read.delim("RSTAN_output_with_NTR_v2/key_for_maternal_cohorts_to_include_in_model_3.NTR_v2.txt",header=T)
    }else {
    ...
    model3.pat.list <- mclapply(1:4, mc.cores = 4,function(i) stan(fit = model3.pat.compiled, data = data2.pat2,chains = 1, chain_id = i,iter=10000,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0")))
    model3.pat <- sflist2stanfit(model3.pat.list)
    save(model3.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.model3.uniform_p_priors.all_chains.pat.including_alpha.RData"))
    cohort.codes=read.delim("RSTAN_output_with_NTR_v2/key_for_paternal_cohorts_to_include_in_model_3.NTR_v2.txt",header=T)
}
