...
write.table(mat.key.model0,"RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.informative_nuclear_families_only.more_stringent.no_GPC.txt",quote=F,sep="\t",row.names=F)
write.table(pat.key.model0,"RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.informative_nuclear_families_only.more_stringent.no_GPC.txt",quote=F,sep="\t",row.names=F)
...
write.table(mat.key.model1,"RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",quote=F,sep="\t",row.names=F)
write.table(pat.key.model1,"RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",quote=F,sep="\t",row.names=F)
...
write.table(mat.key.model3,"RSTAN_output/key_for_maternal_cohorts_to_include_in_model_3.more_stringent.no_GPC.txt",quote=F,sep="\t",row.names=F)
write.table(pat.key.model3,"RSTAN_output/key_for_paternal_cohorts_to_include_in_model_3.more_stringent.no_GPC.txt",quote=F,sep="\t",row.names=F)
...
write.table(mat.key2.model3,"RSTAN_output/key_for_maternal_cohorts_to_include_in_model_3.more_stringent.no_GPC.original_cohorts.txt",quote=F,sep="\t",row.names=F)
write.table(pat.key2.model3,"RSTAN_output/key_for_paternal_cohorts_to_include_in_model_3.more_stringent.no_GPC.original_cohorts.txt",quote=F,sep="\t",row.names=F)
...
save.image("duoHMM_data_for_RSTAN.more_stringent.no_GPC.RData")
