...
names(age.files)=c("CARL","FC","FVG","GPC","NTR","ORCADES","QTR370","QTR610","QTRCoreExome","VB","KORCULA","VIS")
...
write.table(rbind(qtr370.chuck,qtrCoreExome.chuck),"QTR/duoHMM_results/duos_removed_from_QTR370_and_QTRCoreExome_due_to_overlap_with_other_chips.more_stringent.generr_removed.recombination_count.p_0.5.annotated.double_xovers_within_X_SNPs_removed.with_new_QTR.txt",
quote=F,sep="\t")


write.table(removed,"samples_removed_due_to_missing_or_suspicious_age_data.more_stringent.generr_removed.recombination_count.p_0.5.annotated.double_xovers_within_X_SNPs_removed.with_new_QTR.txt",quote=F,sep="\t")
...
write.table(all.data,"all_cohorts.post_MERLIN.generr_removed.recombination_count.p_0.5.annotated.double_xovers_within_X_SNPs_removed.more_stringent.with_new_QTR.txt",quote=F,sep="\t",row.names=F)
...
write.table(mat.key.model0,"RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.informative_nuclear_families_only.more_stringent.with_new_QTR.txt",quote=F,sep="\t",row.names=F)
write.table(pat.key.model0,"RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.informative_nuclear_families_only.more_stringent.with_new_QTR.txt",quote=F,sep="\t",row.names=F)
...
write.table(mat.key.model1,"RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.with_new_QTR.txt",quote=F,sep="\t",row.names=F)
write.table(pat.key.model1,"RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.more_stringent.with_new_QTR.txt",quote=F,sep="\t",row.names=F)
...
write.table(variance.in.mean.by.family,"variance_in_mean_duoHMM_count_by_parent.informative_meioses_only.min_2_kids.more_stringent.with_new_QTR.txt",quote=F,sep="\t")
##### Model 2
...
write.table(mat.key.model2,"RSTAN_output/key_for_maternal_cohorts_to_include_in_model_2.more_stringent.with_new_QTR.txt",quote=F,sep="\t",row.names=F)
write.table(pat.key.model2,"RSTAN_output/key_for_paternal_cohorts_to_include_in_model_2.more_stringent.with_new_QTR.txt",quote=F,sep="\t",row.names=F)
...
write.table(family.type.count.multikid,"number_of_duos_by_cohorts.families_with_multiple_children.with_new_QTR.txt",quote=F,sep="\t")
write.table(family.type.count.inf,"number_of_duos_by_cohorts.informative_duos.with_new_QTR.txt",quote=F,sep="\t")
write.table(family.type.count.inf.nuc,"number_of_duos_by_cohorts.informative_nuc_fam_duos.with_new_QTR.txt",quote=F,sep="\t")
...
write.table(mat.key.model3,"RSTAN_output/key_for_maternal_cohorts_to_include_in_model_3.more_stringent.with_new_QTR.txt",quote=F,sep="\t",row.names=F)
write.table(pat.key.model3,"RSTAN_output/key_for_paternal_cohorts_to_include_in_model_3.more_stringent.with_new_QTR.txt",quote=F,sep="\t",row.names=F)
...
write.table(mat.key2.model3,"RSTAN_output/key_for_maternal_cohorts_to_include_in_model_3.more_stringent.with_new_QTR.original_cohorts.txt",quote=F,sep="\t",row.names=F)
write.table(pat.key2.model3,"RSTAN_output/key_for_paternal_cohorts_to_include_in_model_3.more_stringent.with_new_QTR.original_cohorts.txt",quote=F,sep="\t",row.names=F)


if(FALSE){
##need to alter this to include ORCADES
mat.beta.parameters=read.delim("parameters_for_beta_distribution.model3_maternal.more_stringent.with_new_QTR.txt",header=T)[,1:5]
pat.beta.parameters=read.delim("parameters_for_beta_distribution.model3_paternal.more_stringent.with_new_QTR.txt",header=T)[,1:5]
...
save.image("duoHMM_data_for_RSTAN.more_stringent.with_new_QTR.RData")
}