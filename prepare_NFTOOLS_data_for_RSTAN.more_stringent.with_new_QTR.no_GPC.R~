...
write.table(mat.key.model1,"RSTAN_output/key_for_maternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.with_new_QTR.txt",quote=F,sep="\t",row.names=F)
write.table(pat.key.model1,"RSTAN_output/key_for_paternal_NFTOOLS_cohorts_to_include_in_model_1.more_stringent.with_new_QTR.txt",quote=F,sep="\t",row.names=F)
...
save.image("NFTOOLS_data_for_RSTAN.more_stringent.with_new_QTR.RData")
