...
par(mfrow=c(8,4))
#    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model3.2.",parent,".posteriors.beta_Age.pdf"),height=2.5,width=2.5)
...
#pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model3.2.",parent,".posteriors.sigmasq_m.pdf"),height=2.5,width=2.5)
...
#dev.off()
 ...
 #   pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model3.2.",parent,".posteriors.omega.pdf"),height=2.5,width=2.5)
    plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
    lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2,lwd=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
 #   dev.off()
    
  #  pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model3.2.",parent,".posteriors.mu_m.pdf"),height=2.5,width=2.5)
    plot(density(mysim$mu_m),main="Posterior for mu_m",lwd=2,xlab="mu_m")
    curve(dnorm(x,36,sqrt(6 )),lwd=2,lty=2,add=T)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
  #  dev.off()
...
#    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model3.2.",parent,".posteriors.p.pdf"),height=5,width=5)
#    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model3.2.",parent,".posteriors.p.all_cohorts_combined.pdf"),height=4*2.5,width=7*2.5)
#par(mfrow=c(4,7))
mylabels=c(paste(c("informative, 2 generations","informative, 3 generations","uninformative, 2 kids"),"both parents",sep=", "),paste(c("informative, 2 generations","informative, 3 generations","uninformative, 2 kids"),"1 parent",sep=", "))
names(mylabels)=c("infor.2gen.2parents","infor.3gen.2parents","noninfor.2kids.2gen.2parents","infor.2gen.1parent","infor.3gen.1parent","noninfor.2kids.2gen.1parent")
...
#    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
    ...
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
     ...
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
 }
     mysim<-extract(model1.6.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="paternal"
...
if(FALSE){
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model1.6.2.",myname,".traceplots.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
#    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
    ...
    print(model1.6.mat,pars=c("beta_Age","beta_Agesq","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.modell1.6.2.with_agesq_term.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.modell1.6.2.with_agesq_term.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,                ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model1.6.2.",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model1.6.2.",myname,".posteriors.beta_Agesq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model1.6.NTR_pill_separated.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
my.ylim=5.5
for(i in 1:ncol(mysim$beta_Age)){
    if(i==1){
        plot(density(mysim$beta_Age[,i]),xlim=c(-0.5,0.5),xlab="beta_Age",main="Posterior for beta_Age",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model1.6.NTR_pill_separated.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.mu_m.pdf"),height=5,width=5)
my.ylim=0.2
for(i in 1:ncol(mysim$mu_m)){
    if(i==1){
        plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model1.6.NTR_pill_separated.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model1.6.NTR_pill_separated.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
    lines(density(rigamma(niterations,3,0.5)),lwd=2,lty=2)
legend("topright",c("posterior","prior"),lty=c(1,2),lwd=c(2,2))
dev.off()

pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC/model1.6.NTR_pill_separated.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.tausq.pdf"),height=5,width=5)
    plot(density(mysim$tausq),xlab="tausq",main="Posterior for tausq",lwd=2)
    lines(density(rigamma(niterations,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
...
lines(density(mysim$beta_global),col="black",lwd=3,lty=2)
curve(dnorm(x,0,sqrt(0.05)),add=T,lwd=2,lty=3)
legend("topleft",c(as.character(cohort.codes[order(cohort.codes[,1]),2]),"global","prior"),col=c(mycols[as.character(cohort.codes[,2])],"black","black"),lty=c(rep(1,nrow(cohort.codes)),2,3),lwd=c(rep(2,nrow(cohort.codes)),3,2),cex=0.5)
abline(v=0,lwd=2)
dev.off()
