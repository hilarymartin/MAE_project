...
#sizes=c(max(duoHMM.all$END-duoHMM.all$START))
sizes=c(30000)
...
write.table(overlap.stats,paste0("hotspot_overlap/",out.prefix,".",out.suffix,".male.overlap_with_hotspots.txt"),quote=F,sep="\t")
