...
#Model 1.1 #cohort-specific age effect
    load("RSTAN_output_with_NTR_v2/running_RSTAN.model1.mat.RData")
    ...
    my.model=1
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1"
    ...
    load("RSTAN_output_with_NTR_v2/running_RSTAN.model1.pat.RData")
    mysim<-extract(model1.pat,permuted=T)
    y=data1.pat2$y
    cohort=data1.pat2$cohort
    mother=data1.pat2$family
    cohort.codes=read.delim("RSTAN_output_with_NTR_v2/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T,stringsAsFactors=F)
    Age=data1.pat2$Age
...
#Model 1.2 #common age effect
    load("RSTAN_output_with_NTR_v2/running_RSTAN.model1.2.mat.RData")
    ...
    load("RSTAN_output_with_NTR_v2/running_RSTAN.model1.2.pat.RData")
...
#Model 1.3 #cohort-specific age effects, but drawn from N(beta_global,sigmasq_global); with cohort effect
    load("RSTAN_output_with_NTR_v2/running_RSTAN.model1.3.mat.RData")
    ...
    my.model=1.3
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.3"
    ...
    load("RSTAN_output_with_NTR_v2/running_RSTAN.model1.3.pat.RData")
...
#Model 1.4 ##cohort-specific age effects, but drawn from N(beta_global,sigmasq_global); no cohort effect
    load("RSTAN_output_with_NTR_v2/running_RSTAN.model1.4.mat.RData")
    ...
    my.model=1.4
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.4"
    ...
    load("RSTAN_output_with_NTR_v2/running_RSTAN.model1.4.pat.RData")
...
#Model 2.1. #for informative meioses only, all cohorts, fit cohort effect, BUT NO FAMILY EFFECT
    load("RSTAN_output_with_NTR_v2/running_RSTAN.model2.mat.RData")
    mysim<-extract(model2.mat,permuted=T)
    y=data1.2.mat2$y
    cohort=data1.2.mat2$cohort
    mother=data1.2.mat2$family
    cohort.codes=read.delim("RSTAN_output_with_NTR_v2/key_for_maternal_cohorts_to_include_in_model_2.txt",header=T,stringsAsFactors=F)
    Age=data1.2.mat2$Age
    description="model2.maternal"
    my.model=2
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model2"
    ...
    load("RSTAN_output_with_NTR_v2/running_RSTAN.model2.pat.RData")
    mysim<-extract(model2.pat,permuted=T)
    y=data1.2.pat2$y
    cohort=data1.2.pat2$cohort
    mother=data1.2.pat2$family
    cohort.codes=read.delim("RSTAN_output_with_NTR_v2/key_for_paternal_cohorts_to_include_in_model_2.txt",header=T,stringsAsFactors=F)
...
#Model 2.2 #common age effect
    load("RSTAN_output_with_NTR_v2/running_RSTAN.model2.2.mat.RData")
    ...
    my.model=2.2
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model2.2"
...
#Model 2.2 #common age effect
    load("RSTAN_output_with_NTR_v2/running_RSTAN.model2.2.pat.RData")
    ...
    load("RSTAN_output_with_NTR_v2/RSTAN.model3.adjusted_priors.all_chains.mat.including_alpha.RData")
    ...
    my.model=3
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model3"
    ...
    load("RSTAN_output_with_NTR_v2/RSTAN.model3.adjusted_priors.all_chains.pat.including_alpha.RData")
    mysim<-extract(model3.pat,permuted=T)
    y=data2.pat2$y
    cohort=data2.pat2$cohort
    mother=data2.pat2$family
    cohort.codes=read.delim("RSTAN_output_with_NTR_v2/key_for_paternal_cohorts_to_include_in_model_3.txt",header=T,stringsAsFactors=F)
    Age=data2.pat2$Age
    ...
    load("RSTAN_output_with_NTR_v2/RSTAN.model3.2.adjusted_priors.all_chains.mat.including_alpha.RData")
    ...
    my.model=3.2
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model3.2"
    ...
    load("RSTAN_output_with_NTR_v2/RSTAN.model3.2.adjusted_priors.all_chains.pat.including_alpha.RData")
...
#### Model 1.3: cohort-specific age effects, but drawn from N(beta_global,sigmasq_global); with cohort effect weaker priors on age effect -- beta_Age drawn from distribution
    ...
    my.model=1.32
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.32"
...
#### Model 1.3, uniform_prior_on_sigmasq_m. -- beta_Age drawn from distribution
   load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.3.uniform_prior_on_sigmasq_m.all_chains.mat.including_alpha.RData")   
    ...
    my.model=1.33
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.33"
...
#### Model 1.5 -- negative binomial model for informative families only
   load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.all_chains.mat.including_alpha.RData")
    ...
    my.model=1.5
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.5"
...
#### Model 1.5, with different link function    -- negative binomial model for informative families only, with different link function
   ...
   load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.different_link.all_chains.mat.including_alpha.RData")
    ...
    my.model=1.52
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.52"
...
#### Model 1.5, with different link function  and weaker priors  -- negative binomial model for informative families only, with different link function
   load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.5.different_link.weaker_priors.all_chains.mat.including_alpha.RData")
    ...
    my.model=1.53
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.53"
...
#### Model 1.7 -- beta_Age drawn from distribution; with family effect and cohort effect; using t distribution for Y and prior on beta_Age
    ...
    my.model=1.7
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.7"
...
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.mat.including_alpha.mu_m_N_41_100.sigmasq_m_IG_2_40.RData"))
    ...
    my.model=1.62
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.62"
...
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NTR_v2/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_27_64.sigmasq_m_IG_2_15.RData"))
    mysim<-extract(model1.6.pat,permuted=T)
    y=data1.pat2$y
    cohort=data1.pat2$cohort
    mother=data1.pat2$family
...
#### Model 1.6.2 -- common beta_Age; alphas drawn from N(mu_cohort,sigmasq)
    ...
    Age=data1.mat2$Age
    description="model1.6.2.uniform_priors.maternal"
    my.model=1.62
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.62"
    ...
    cohort.codes=read.delim("RSTAN_output_with_NTR_v2/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T,stringsAsFactors=F)
    Age=data1.pat2$Age
    description="model1.6.2.uniform_priors.paternal"
    my.model=1.62
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.62"
...
#### Model 1.5.4 -- negative binomial model for informative families only, no cohort effect but family effects drawn from distribution with cohrot-specific mean; common beta_Age
    cohort_by_family=rep(NA,data1.mat2$I)
    for(i in 1:data1.mat2$I){
        cohort_by_family[i] <- data1.mat2$cohort[data1.mat2$family ==i][1]
    }
    ...
    my.model=1.54
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.54"
...
#### Model 1.5.4 -- negative binomial model for informative families only, no cohort effect but family effects drawn from distribution with cohrot-specific mean; common beta_Age
    ...
    cohort.codes=read.delim("RSTAN_output_with_NTR_v2/key_for_maternal_cohorts_to_include_in_model_1.txt",header=T,stringsAsFactors=F)
    Age=data1.mat2$Age
    description="model1.5.4.uniform_priors.maternal"
    my.model=1.54
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.54"
...
#### Model 1.5 -- negative binomial model for informative families only
    ...
    cohort.codes=read.delim("RSTAN_output_with_NTR_v2/key_for_paternal_cohorts_to_include_in_model_1.txt",header=T,stringsAsFactors=F)
    Age=data1.pat2$Age
    description="model1.5.4.uniform_priors.paternal"
    my.model=1.54
    J=length(y)
    mydir="RSTAN_output_with_NTR_v2/model1.54"
...
for(i in 1:100){
  ...
  y.sim <- simulate_y(N=J,a0=umap$par[grep("exp_a0[",names(umap$par),fixed=T)][mother],beta_Age=umap$par[grep("beta_Age[",names(umap$par),fixed=T)],age=Age,omega=umap$par["omega"],cohort=cohort,beta_Cohort=umap$par[grep("^beta_Cohort",names(umap$par),perl=T)],
                      model=my.model)
    }else if(my.model==2){
        y.sim <- simulate_y(N=J,mu_m=umap$par["mu_m"],beta_Age=umap$par[grep("beta_Age[",names(umap$par),fixed=T)],age=Age,tausq=umap$par["tausq"],cohort=cohort,beta_Cohort=umap$par[grep("^beta_Cohort",names(umap$par),perl=T)],model=my.model)
    }else if(my.model==2.2){
        y.sim <- simulate_y(N=J,mu_m=umap$par["mu_m"],beta_Age=umap$par["beta_Age"],age=Age,tausq=umap$par["tausq"],cohort=cohort,beta_Cohort=umap$par[grep("^beta_Cohort",names(umap$par),perl=T)],model=my.model)
    }else if(my.model==3){
...
pdf(paste(mydir,"/","ecdfs_of_observed_and_simulated_y_from_MAP_estimates.",description,".pdf",sep=""),height=20,width=20)
for(i in 1:nrow(MAP.sims)){
    if(i==1){
        plot(ecdf(MAP.sims[i,]),xlab="crossover counts",col="grey",verticals=T,main="ecdf of Y simulated using MAP estimates",pch=NA,cex.main=1.5,cex.lab=1.5,cex.acis=1.5)
    } else {
        lines(ecdf(MAP.sims[i,]),col="grey",verticals=T,pch=NA)
    }
}
    lines(ecdf(y),col="red",verticals=T,pch=NA)
legend("topleft",c("observed","simulated using MAP estimate"),col=c("red","grey"),lty=1,cex=2)
dev.off()
...
for(i in 1:nrow(best.draw.sims)){
    if(i==1){
        plot(ecdf(best.draw.sims[i,cohort==c]),xlab="crossover counts",col="grey",verticals=T,main=paste0(cohort.codes[cohort.codes$Code==c,"Cohort"],", n=",sum(cohort==c)),pch=NA,cex.main=2,cex.lab=2,cex.axis=2)
    } else {
...
lines(ecdf(y[cohort==c]),col="red",verticals=T,pch=NA)
if(c==1){
legend("topleft",c("observed","simulated"),col=c("red","grey"),lty=1,cex=2)
}
}
dev.off()
...
pdf(paste(mydir,"/","histogram_of_summary_statistics.MAF_estimates.",description,".pdf",sep=""))
par(mfrow=c(2,3))
...
if(my.model==1|my.model==1.3|my.model==1.32|my.model==1.33|my.model==1.7){
y.predict.map <- predict_y(a0=umap$par[grep("a0[",names(umap$par),fixed=T)][mother],beta_Age=umap$par[grep("beta_Age[",names(umap$par),fixed=T)],age=Age,cohort=cohort,beta_Cohort=umap$par[grep("^beta_Cohort",names(umap$par),perl=T)],model=my.model)
}else if(my.model==1.2){
...
y.predict.map <- predict_y(a0=umap$par[grep("exp_a0[",names(umap$par),fixed=T)][mother],beta_Age=umap$par[grep("beta_Age[",names(umap$par),fixed=T)],age=Age,cohort=cohort,p_by_cohort=umap$par[grep("p_by_cohort",names(umap$par),fixed=T)],model=my.model)
}else if(my.model==3.2){
...
for(c in 1:length(unique(cohort))){
plot(y_predict[cohort==c],classic_residuals[cohort==c],ylab="estimated residual",xlab="expected count",main=paste0(cohort.codes[cohort.codes$Code==c,"Cohort"],", n=",sum(cohort==c)),cex.main=2,cex.lab=2,cex.axis=2)
abline(h=0,col="red")
}
dev.off()
...
for(c in 1:length(unique(cohort))){
    plot(density(classic_residuals[cohort==c]),xlab="estimated residuals",main=paste0(cohort.codes[cohort.codes$Code==c,"Cohort"],", n=",sum(cohort==c)),cex.main=2,cex.lab=2,cex.axis=2)
    qqnorm(classic_residuals[cohort==c],xlab="Expected",ylab="Observed",main=paste0("QQ plot of residuals for ",cohort.codes[cohort.codes$Code==c,"Cohort"]),cex.main=2,cex.lab=2,cex.axis=2,cex=2)
