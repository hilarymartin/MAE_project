...
names(age.files)=names(all.events)[2:7]
...
write.table(mat.key.model1,"RSTAN_output/key_for_maternal_NFTOOLS_cohorts_to_include_in_model_1.txt",quote=F,sep="\t",row.names=F)
write.table(pat.key.model1,"RSTAN_output/key_for_paternal_NFTOOLS_cohorts_to_include_in_model_1.txt",quote=F,sep="\t",row.names=F)
