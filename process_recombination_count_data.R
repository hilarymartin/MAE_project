...
write.table(rbind(maternal.recomb.inform,paternal.recomb.inform),paste0(out.prefix,".all_crossovers_from_informative_meioses.p_",p.cutoff,".txt"),quote=F,sep="\t",row.names=F)
