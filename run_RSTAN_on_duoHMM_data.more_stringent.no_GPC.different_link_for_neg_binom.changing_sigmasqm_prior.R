  ...
  if(argv[1] ==1){
    ...
    if(!print.only){
     ...
     model3.mat <- sflist2stanfit(model3.pat.list)  
        save(model3.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.beta_age_by_cohort.adjusted_priors.all_chains.mat.including_alpha.RData"))
        print(model3.mat,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
    } else {
        load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.beta_age_by_cohort.adjusted_priors.all_chains.mat.including_alpha.RData")
    }
...
if(argv[1] ==2){
  ...
  cat("Model 3 paternal, with adjusted priors\n")
    if(!print.only){
     ...
     save(model3.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.beta_age_by_cohort.adjusted_priors.all_chains.pat.including_alpha.RData"))
     print(model3.pat,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
    } else {
        load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.beta_age_by_cohort.adjusted_priors.all_chains.pat.including_alpha.RData")
    }
...
cohort.codes2=cohort.codes2[order(cohort.codes2[,1]),]
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model3.beta_age_by_cohort.",parent,".posteriors.beta_Age.pdf"),height=5,width=5)
    my.ylim=470
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model3.beta_age_by_cohort.",parent,".posteriors.all_parameters.pdf"),height=7*3,width=4*3)
...
#        model3.mat <- sflist2stanfit(model3.mat.list)
 model3.mat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model3.v2.adjusted_priors.stan",data=data2.mat2,iter=niterations,chains=4,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0"))
        save(model3.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.adjusted_priors.all_chains.mat.including_alpha.RData"))
        print(model3.mat,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
    } else {
        load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.adjusted_priors.all_chains.mat.including_alpha.RData")
    }
    mysim<-extract(model3.mat,permuted=T)
    parent="adjusted_priors.maternal"
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_3.more_stringent.no_GPC.txt",header=T,stringsAsFactors=F)
...
#        model3.pat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model3.v2.adjusted_priors.stan",data=data2.pat2,iter=10,chains=0,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0"))
 ...
 #       model3.pat <- sflist2stanfit(model3.pat.list)
   model3.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model3.v2.adjusted_priors.stan",data=data2.pat2,iter=niterations,chains=4,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0" ))
        save(model3.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.adjusted_priors.all_chains.pat.including_alpha.RData"))
        print(model3.pat,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
    } else {
        load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.adjusted_priors.all_chains.pat.including_alpha.RData")
    }
    mysim<-extract(model3.pat,permuted=T)
    parent="adjusted_priors.paternal"
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_3.more_stringent.no_GPC.txt",header=T,stringsAsFactors=F)
...
cohort.codes=cohort.codes[order(cohort.codes[,1]),]
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model3.",parent,".posteriors.beta_Age.pdf"),height=5,width=5)
    my.ylim=32
    for(i in 1:ncol(mysim$beta_Age)){
        if(i==1){
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model3.",parent,".posteriors.p.pdf"),height=5,width=5)
    for(i in 1:ncol(mysim$p_by_cohort)){
...
dev.off()
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model3.",parent,".posteriors.sigmasq_global.pdf"),height=5,width=5)
...
lines(rigamma(niterations,3,0.1),lty=2,lwd=2)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model3.",parent,".posteriors.omega.pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model3.",parent,".posteriors.mu_m.pdf"),height=5,width=5)
...
save(model3.2.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.2.adjusted_priors.all_chains.mat.including_alpha.RData"))
} else {
load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.2.adjusted_priors.all_chains.mat.including_alpha.RData")
...
if(!print.only){
    ...
    save(model3.2.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.2.adjusted_priors.all_chains.pat.including_alpha.RData"))

} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.2.adjusted_priors.all_chains.pat.including_alpha.RData")
...
mysim.model3.pat = mysim
 ...
 pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model3.2.",parent,".posteriors.beta_Age.pdf"),height=5,width=5)
...
dev.off()
 ...
 pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model3.2.",parent,".posteriors.all_parameters.pdf"),height=8*3,width=4*3)
...
#    model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data1.mat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","beta_global","sigmasq_global","tausq","mu_m","sigmasq_m","a0")))
 ...
 print(model1.6.mat,pars=c("beta_Age","beta_global","sigmasq_global","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
} else {
...
#    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
 model1.6.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","beta_global","sigmasq_global","tausq","mu_m","sigmasq_m","a0"))
    ...
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.mu_m.pdf"),height=5,width=5)
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.17
        my.xlim=100
    }else {
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
    lines(density(rigamma(niterations,3,0.5)),lwd=2,lty=2)
legend("topright",c("posterior","prior"),lty=c(1,2),lwd=c(2,2))
dev.off()
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.tausq.pdf"),height=5,width=5)
...
print(model1.5.mat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData"))
} else {
  load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData"))
}
...
print(model1.5.pat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData"))
} else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData"))
}
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
my.ylim=20
for(i in 1:ncol(mysim$beta_Age)){
    if(i==1){
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
lines(density(rigamma(niterations,3,0.1)),lty=2,lwd=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()

pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
my.ylim=0.7
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
#if(myname=="maternal"){
  my.ylim=3
#    my.xlim=4
#}else{
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.",myname,".posteriors.omega.pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2,lwd=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.",myname,".posteriors.all_parameters.pdf"),height=17,width=4)
...
print(model1.5.mat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
   save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.different_link.all_chains.",myname,".including_alpha.RData"))
} else {
  load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.different_link.all_chains.",myname,".including_alpha.RData")
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
...
#    model1.5.pat <- sflist2stanfit(model1.5.pat.list)
 ...
 print(model1.5.pat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.different_link.all_chains.",myname,".including_alpha.RData"))
 } else {
   load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.different_link.all_chains.",myname,".including_alpha.RData")
}
  mysim<-extract(model1.5.pat,permuted=T)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.different_link.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.different_link.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.different_link.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.different_link.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
#if(myname=="maternal"){
#  my.ylim=3
#    my.xlim=4
#}else{
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.different_link.",myname,".posteriors.omega.pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2,lwd=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
...
if(!print.only){
 ...
 print(model1.5.mat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.different_link.weaker_priors.all_chains.mat.including_alpha.RData"))
} else {
load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.different_link.weaker_priors.all_chains.mat.including_alpha.RData")
}
...
print(model1.5.pat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.different_link.weaker_priors.all_chains.pat.including_alpha.RData"))
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.different_link.weaker_priors.all_chains.pat.including_alpha.RData")
}
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.different_link.weaker_priors.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.different_link.weaker_priors.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()
}
}
...
#    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
    ...
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.all_chains.mat.including_alpha.mu_m_N_",
...
#           model1.6.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0"))
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
     save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
} else {
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    my.ylim=100
#    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.13
        my.xlim=100
    }else {
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
if(!print.only){
    ...
    print(model1.6.mat,pars=c("beta_Age","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.Poisson_model.linear_mean.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.Poisson_model.linear_mean.all_chains.mat.including_alpha.mu_m_N_",
                mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    ...
    print(model1.6.pat,pars=c("beta_Age","sigmasq_m","mu_m"),digits=4)
     ...
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.Poisson_model.linear_mean.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",
                 sigmasq_m_beta,".RData"))
 }
     mysim<-extract(model1.6.pat,permuted=T)
     mysim.model1.pat = mysim
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=c(-0.5,0.5),xlab="beta_Age",main="Posterior for beta_Age",lwd=2,ylim=c(0,16))
    abline(v=0,lwd=2)
    curve(dnorm(x,0,1),lty=2,lwd=2,add=T)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    if(argv[1]==9){
        my.ylim=0.13
        my.xlim=100
    }else {
...
if(!print.only){
    ...
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.cohort_specific_tausq.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.cohort_specific_tausq.all_chains.mat.including_alpha.mu_m_N_",
                mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
...
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="maternal"
  ...
  data1.pat2$sigmasq_alpha_prior = sigmasq_alpha_prior
    ...
    if(!print.only){
        ...
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.pat,permuted=T)
...
mean_alpha_prior = mu_alpha_prior
 ...
 pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.",myname,".posteriors.beta_Age.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
lines(density(exp(rnorm(10000,0,sqrt(0.01)))),lwd=2,lty=2)	
   ...
   abline(v=1,lwd=2)						
dev.off()
 pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.",myname,".posteriors.all_parameters.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=16,width=4)
par(mfrow=c(4,1),oma=c(0,0,3,0),mar=c(5,4,2,1))
  ...
  curve(dnorm(x,0,sqrt(0.01)),lwd=2,lty=2,add=T)
   ...
   my.ylim=15
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
        }else {
            lines(density(mysim$mu_m[,i]),col=mycols[as.character(cohort.codes[i,2])],lwd=2)
        }
    }
   ...
   my.ylim=500
    for(i in 1:ncol(mysim$sigmasq_m)){
        if(i==1){
            plot(density(mysim$sigmasq_m[,i]),xlim=range(mysim$sigmasq_m),xlab="mu_m",main="",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
        }else {
            lines(density(mysim$sigmasq_m[,i]),col=mycols[as.character(cohort.codes[i,2])],lwd=2)
        }
    }
...
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.cohort_specific_omega.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.cohort_specific_omega.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="maternal"
    ...
    if(!print.only){
        ...
        print(model1.5.pat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.cohort_specific_omega.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.cohort_specific_omega.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.pat,permuted=T)
mysim.model2.pat = mysim
    sum(mysim.model2.pat$beta_Age>0)/length(mysim.model2.pat$beta_Age)
...
#pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.cohort_specific_omega.",myname,".posteriors.beta_Age.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.cohort_specific_omega.",myname,".posteriors.all_parameters.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=10,width=10)
...
#dev.off()
#pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.cohort_specific_omega.",myname,".posteriors.mu_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
#dev.off()
 #   pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.cohort_specific_omega.",myname,".posteriors.sigmasq_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
if(myname=="maternal"){
    my.ylim=3
    my.xlim=4
}else{
...
#dev.off()
#pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.cohort_specific_omega.",myname,".posteriors.omega.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
for(i in 1:ncol(mysim$omega)){
print(i )
if(argv[1]==5){
    my.ylim=4
...
#    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
    ...
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==55){
        myname="uniform_priors_on_beta_Age.maternal"
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==57){
        myname="uniform_priors_on_mu_m_cohort.maternal"
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==59){
        myname="uniform_priors_on_tau.maternal"
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==61){
        myname="uniform_priors_on_sigma_m.maternal"
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.mat.including_alpha.RData"))
    }
} else{
    if(argv[1]==47){
        myname="uniform_priors.maternal"
             load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors.all_chains.mat.including_alpha.RData")
        }
    if(argv[1]==55){
        myname="uniform_priors_on_beta_Age.maternal"
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==57){
        myname="uniform_priors_on_mu_m_cohort.maternal"
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.mat.including_alpha.RData"))
    }
      if(argv[1]==59){
          myname="uniform_priors_on_tau.maternal"
          load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.mat.including_alpha.RData"))
      }
        if(argv[1]==61){
            myname="uniform_priors_on_sigma_m.maternal"
            load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.mat.including_alpha.RData"))
        }
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
...
#    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
    ...
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
                                        #    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors.all_chains.pat.including_alpha.RData")
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==56){
        myname="uniform_priors_on_beta_Age.paternal"
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==58){
        myname="uniform_priors_on_mu_m_cohort.paternal"
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==60){
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.pat.including_alpha.RData"))
        myname="uniform_priors_on_tau.paternal"
    }
    if(argv[1]==62){
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.pat.including_alpha.RData"))
   ...
   if(argv[1]==48){
       myname="uniform_priors.paternal"
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData")
...
#pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.uniform_priors.v4.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
        if(argv[1] %in% c(47,55,57,59,61)){
        my.ylim=0.6
        my.xlim=c(32,46)
    }else {
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
        if(argv[1] %in% c(47,55,57,59,61)){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.tausq.pdf"),height=5,width=5)
...
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.uniform_priors.all_chains.mat.including_alpha.RData"))
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.uniform_priors.all_chains.mat.including_alpha.RData")
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="maternal"
...
#      model1.5.pat <- sflist2stanfit(model1.5.pat.list)
      model1.5.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.5.4.uniform_priors.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","omega","mu_m","sigmasq_m","exp_a0"))
        print(model1.5.pat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.uniform_priors.all_chains.pat.including_alpha.RData"))
    } else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.uniform_priors.all_chains.pat.including_alpha.RData"))
}
    mysim<-extract(model1.5.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="paternal"
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.uniform_priors.v4.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
abline(v=0,lwd=2)
dev.off()


pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.uniform_priors.v4.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
if(myname=="maternal"){
    my.ylim=1.7
} else {
    my.ylim=1.7
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.uniform_priors.v4.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=1
        my.xlim=10
    }else {
...
dev.off()
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.uniform_priors.v4.",myname,".posteriors.omega.pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
...
#    model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data1.mat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0")))
 #   model1.6.mat <- sflist2stanfit(model1.6.mat.list)
   model1.6.mat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.t_distribution_on_alphas.stan",data=data1.mat2,iter=niterations,chains=4,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0"))             
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".RData"))
} else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="maternal"
...
#    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
    ...
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas.df_",df.alpha,".RData"))
}else{
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas.df_",df.alpha,".RData"))
 }
    mysim<-extract(model1.6.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="paternal"
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.beta_Age.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    if(myname=="maternal"){
    ...
    dev.off()
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.mu_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.sigmasq_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.tausq.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),xlab="tausq",main="Posterior for tausq",lwd=2)
    lines(density(rigamma(niterations,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    if(myname=="maternal"){
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){my.ylim=0.6}else {my.ylim=0.7}
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    legend("topright",c(as.character(cohort.codes[order(cohort.codes[,1]),2]),"prior"),col=c(mycols[as.character(cohort.codes[,2])],"black"),lty=c(rep(1,nrow(cohort.codes)),2),lwd=c(rep(2,nrow(cohort.codes)),3),cex=0.5)
    dev.off()
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.2.",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),xlab="tausq",main="Posterior for tausq",lwd=2)
    lines(density(rigamma(niterations,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
...
#        model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data0.mat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0","beta_global","sigmasq_global")))
    ...
    if(!print.only){ 
#    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.",myname,".all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.mat,permuted=T)
    ...
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.",myname,".all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",                sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.mat,permuted=T)
}
...
#         model1.6.pat <- sflist2stanfit(model1.6.pat.list)
    ...
    if("beta_global" %in% names(mysim)){
        ...
        print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
         ...
         load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.",myname,".all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
         mysim<-extract(model1.6.pat,permuted=T)
     }

 }
if(FALSE){
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/",myname,".traceplots.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),lwd=2,main="Posterior for tausq",xlab="tausq")
    lines(density(rigamma(niterations,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lty=c(1,2),lwd=2)
    dev.off()
...
save(model3.2.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.2.adjusted_priors.different_link.all_chains.mat.including_alpha.RData"))
print(model3.2.mat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
} else {
load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.2.adjusted_priors.different_link.all_chains.mat.including_alpha.RData")
print(model3.2.mat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
}
...
data2.pat2$sigmasq_alpha_prior = 0.2
    ...
    save(model3.2.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.2.adjusted_priors.different_link.all_chains.pat.including_alpha.RData"))
    print(model3.2.pat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.2.adjusted_priors.different_link.all_chains.pat.including_alpha.RData")
}
    mysim<-extract(model3.2.pat,permuted=T)
    parent="adjusted_priors.paternal"
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_3.more_stringent.no_GPC.txt",header=T,stringsAsFactors=F)
 ...
 pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model3.2.",name,".posteriors.beta_Age.pdf"),height=5,width=5)
    plot(density(exp(mysim$beta_Age)),xlab=expression(beta['age']),main="",cex.lab=1.2,lwd=2,xlim=c(0.997,1.0045),ylim=c(0,500))
lines(density(exp(rnorm(10000,0,sqrt(0.01)))),lwd=2,lty=2)
   legend("topright",c("posterior","prior"),lty=c(1,2),lwd=2)
   abline(v=1,lwd=2)
dev.off()

 pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model3.2.",name,".posteriors.all_parameters.pdf"),height=7*3,width=4*3)
...
if(!print.only){
 ...
 print(model1.6.mat,pars=c("beta_Age","beta_global","sigmasq_global","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.ART_separated.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
} else {
  load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.ART_separated.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.ART_separated.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.all_parameters.pdf"),height=20,width=4)
...
if(!print.only){
   model1.6.mat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.stan",data=data1.mat2,iter=niterations,chains=4,pars=c("beta_Age","beta_global","sigmasq_global","tausq","mu_m","sigmasq_m","a0"))
 print(model1.6.mat,pars=c("beta_Age","beta_global","sigmasq_global","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.NTR_and_ORCADES_pill_separated.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
} else {
  load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.NTR_and_ORCADES_pill_separated.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.6.NTR_and_ORCADES_pill_separated.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,
...
print(model1.5.mat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
  ...
  load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData")
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
...
model3.2.mat.list <- mclapply(1:4, mc.cores = 4,function(i) stan(fit = model3.2.mat.compiled, data = data2.mat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0")))
model3.2.mat <- sflist2stanfit(model3.2.mat.list)
save(model3.2.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.2.",name,".RData"))
print(model3.2.mat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
} else {
load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.2.",name,".RData"))
print(model3.2.mat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
}
mysim<-extract(model3.2.mat,permuted=T)
parent="adjusted_priors.maternal"
...
if(!print.only){
    ...
    model3.2.pat <- sflist2stanfit(model3.2.pat.list)
    save(model3.2.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.2.",name,".RData"))
    print(model3.2.pat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
} else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.model3.2.",name,".RData"))
}
...
if(!print.only){
      model1.6.mat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.stan",data=data1.mat2,iter=niterations,chains=4,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0"))
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.all_chains.mat.informative_nuclear_families.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.all_chains.mat.informative_nuclear_families.including_alpha.mu_m_N_",
                mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.informative_nuclear_families_only.more_stringent.no_GPC.txt",header=T)
    ...
    data1.pat2$cohort_by_family = cohort_by_family
     ...
     if(!print.only){
           model1.6.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0"))
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
     save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.all_chains.pat.informative_nuclear_families.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
} else {
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.6.2.all_chains.pat.informative_nuclear_families.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",
...
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.all_chains.mat.informative_nuclear_families.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.all_chains.mat.informative_nuclear_families.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.informative_nuclear_families_only.more_stringent.no_GPC.txt",header=T)
    myname="maternal.informative_nuclear_families"
    ...
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.all_chains.pat.informative_nuclear_families.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.pat,permuted=T)
mysim.model2.pat = mysim
    sum(mysim.model2.pat$beta_Age>0)/length(mysim.model2.pat$beta_Age)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.",myname,".posteriors.mu_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
      if(myname=="maternal"){my.ylim=1.6}else {my.ylim=1.6}
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.",myname,".posteriors.sigmasq_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/model1.5.4.",myname,".posteriors.omega.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2,lwd=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
