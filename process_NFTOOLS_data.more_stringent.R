cohorts=c("NTR","QTR370","QTR610","FC","GPC","VB","ORCADES")
dirs=c("NTR","QTR","QTR","FC","GPC","VB","ORCADES")
...
fam.files=c("NTR/input_for_SHAPEIT2/NTR.1.more_stringent.generr_removed.fam",
    "QTR/input_for_SHAPEIT2/QTR_minus_MZs.370K.1.post_MERLIN.more_stringent.generr_removed.fam",    "QTR/input_for_SHAPEIT2/QTR_minus_MZs.610K.1.post_MERLIN.more_stringent.generr_removed.fam",
    "FC/input_for_SHAPEIT2/FC.1.more_stringent.generr_removed.fam",    "GPC/input_for_SHAPEIT2/GPC.1.more_stringent.generr_removed.fam",    "VB/input_for_SHAPEIT2/VB.1.more_stringent.generr_removed.fam",
    "ORCADES/input_for_SHAPEIT2/ORCADES.1.more_stringent.generr_removed.fam")
    
names(counts.files)=c("NTR","QTR370","QTR610","FC","GPC","VB","ORCADES") 
...
for(c in 1:length(counts.files)){
    ...
    outliers[[names(counts.files)[c]]]=events.by.child[(events.by.child$nkids>2)&((events.by.child$sex=="male" & (events.by.child$Freq<9 |events.by.child$Freq > 45))|(events.by.child$sex=="female" &
    ...
    events.by.child=events.by.child[!(events.by.child$nkids>2 & ((events.by.child$sex=="male" & (events.by.child$Freq<9 |events.by.child$Freq > 45))|(events.by.child$sex=="female" &
         (events.by.child$Freq<10 |events.by.child$Freq > 76)))|(events.by.child$nkids==1) &  ((events.by.child$sex=="male" & (events.by.child$Freq<2*9 |events.by.child$Freq > 2*45))|(events.by.child$sex=="female"
...
save(all.events,file="NFTOOLS_results/NFTOOLS_counts.all_families_except_outliers.more_stringent.RData")
...
names(duoHMM.files)=c("NTR","QTR370","QTR610","FC","GPC","VB","ORCADES")
    
age.files=c("NTR/NTR_v2_minus_MZs.with_parental_age.txt","QTR/QTR_minus_MZs.370K.with_parental_age.txt","QTR/QTR_minus_MZs.610K.with_parental_age.txt","FC/FC.with_parental_age.txt",
    "GPC/GPC.with_parental_age.txt",    "VB/valborbera_b37-related.with_parental_age.txt","ORCADES/ORCADES.with_parental_age.txt")
