...
write.table(data0,"NTR/duoHMM_results/NTR_v2_minus_MZs.all.post_MERLIN.max_0.01_missing.generr_removed.recombination_count.p_0.5.annotated.double_xovers_within_X_SNPs_removed.informative_nuclear_families_only.txt",quote=F,
            sep="\t",row.names=F)
...
write.table(data0,"NTR/duoHMM_results/NTR_v2_minus_MZs.all.post_MERLIN.max_0.01_missing.generr_removed.recombination_count.p_0.5.annotated.double_xovers_within_X_SNPs_removed.informative_meioses_multikid_families_only.txt",
