...
if(argv[1] ==1){
    ...
    if(!print.only){
     model3.pat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model3.beta_age_by_cohort.stan",data=data2.mat2,iter=10,chains=0,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0"))
     ...
     model3.mat <- sflist2stanfit(model3.pat.list)  
        save(model3.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.model3.beta_age_by_cohort.adjusted_priors.all_chains.mat.including_alpha.RData"))
...
if(argv[1] ==2){
    ...
    if(!print.only){
     model3.pat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model3.beta_age_by_cohort.stan",data=data2.pat2,iter=10,chains=0,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0"))
     ...
     save(model3.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.model3.beta_age_by_cohort.adjusted_priors.all_chains.pat.including_alpha.RData"))
...
cohort.codes2=cohort.codes2[order(cohort.codes2[,1]),]
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model3.beta_age_by_cohort.",parent,".posteriors.beta_Age.pdf"),height=5,width=5)
    my.ylim=45
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model3.beta_age_by_cohort.",parent,".posteriors.all_parameters.pdf"),height=7*3,width=4*3)
...
if(!print.only){
     model3.pat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model3.2.adjusted_priors.stan",data=data2.mat2,iter=10,chains=0)
     model3.pat.list <- mclapply(1:4, mc.cores = 4,function(i) stan(fit = model3.pat.compiled, data = data2.mat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","p_by_cohort","omega","mu_m","sigmasq_m")))
     model3.2.mat <- sflist2stanfit(model3.pat.list)  

     save(model3.2.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.model3.2.adjusted_priors.all_chains.mat.including_alpha.RData"))
} else {
...
if(!print.only){
     model3.pat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model3.2.adjusted_priors.stan",data=data2.pat2,iter=10,chains=0)
     model3.pat.list <- mclapply(1:4, mc.cores = 4,function(i) stan(fit = model3.pat.compiled, data = data2.pat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","p_by_cohort","omega","mu_m","sigmasq_m")))
     model3.2.pat <- sflist2stanfit(model3.pat.list)  
    save(model3.2.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.model3.2.adjusted_priors.all_chains.pat.including_alpha.RData"))
} else {
 ...
 pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model3.2.",parent,".posteriors.beta_Age.pdf"),height=5,width=5)
...
dev.off()
 ...
 pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model3.2.",parent,".posteriors.all_parameters.pdf"),height=8*3,width=4*3)
...
if(!print.only){
 ...
 print(model1.6.mat,pars=c("beta_Age","beta_global","sigmasq_global","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
} else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
...
if(!print.only){
    ...
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.mu_m.pdf"),height=5,width=5)
if(myname=="maternal"){my.ylim=0.2}else {my.ylim=0.4}
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
...
dev.off()
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.tausq.pdf"),height=5,width=5)
...
print(model1.5.mat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData"))
} else {
  load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData"))
}
...
if(!print.only){
  model1.5.pat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.5.4.cohort_specific_beta_Age.stan",data=data1.pat2,iter=niterations,chains=0)
...
print(model1.5.pat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData"))
} else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData"))
}
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
my.ylim=20
for(i in 1:ncol(mysim$beta_Age)){
    if(i==1){
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
lines(density(rigamma(niterations,3,0.1)),lty=2,lwd=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()

pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
my.ylim=0.7
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
#if(myname=="maternal"){
  my.ylim=3
#    my.xlim=4
#}else{
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.",myname,".posteriors.omega.pdf"),height=5,width=5)
...
print(model1.5.mat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
   save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.different_link.all_chains.",myname,".including_alpha.RData"))
} else {
  load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.different_link.all_chains.",myname,".including_alpha.RData")
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
...
#    model1.5.pat <- sflist2stanfit(model1.5.pat.list)
 ...
 print(model1.5.pat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.different_link.all_chains.",myname,".including_alpha.RData"))
 } else {
   load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.different_link.all_chains.",myname,".including_alpha.RData")
}
  mysim<-extract(model1.5.pat,permuted=T)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.different_link.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.different_link.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.different_link.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.different_link.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
#if(myname=="maternal"){
#  my.ylim=3
#    my.xlim=4
#}else{
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.different_link.",myname,".posteriors.omega.pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2,lwd=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
...
if(!print.only){
 ...
 print(model1.5.mat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.different_link.weaker_priors.all_chains.mat.including_alpha.RData"))
} else {
load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.different_link.weaker_priors.all_chains.mat.including_alpha.RData")
}
...
print(model1.5.pat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.different_link.weaker_priors.all_chains.pat.including_alpha.RData"))
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.different_link.weaker_priors.all_chains.pat.including_alpha.RData")
}
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.different_link.weaker_priors.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.different_link.weaker_priors.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()
}
}
...
#      model1.6.mat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.stan",data=data1.mat2,iter=niterations,chains=4,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0"))
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.mat.including_alpha.mu_m_N_",
...
#           model1.6.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0"))
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
     save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
} else {
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    my.ylim=100
#    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    if(myname=="maternal"){my.ylim=0.35}else {my.ylim=0.55}
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
        }else {
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.13
        my.xlim=100
    }else {
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
if(!print.only){
    ...
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.cohort_specific_tausq.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.cohort_specific_tausq.all_chains.mat.including_alpha.mu_m_N_",
                mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    ...
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
     ...
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.cohort_specific_tausq.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",
                 sigmasq_m_beta,".RData"))
 }
     mysim<-extract(model1.6.pat,permuted=T)
mysim.model1.pat = mysim
...
if(argv[1]==45){
    ...
    data1.mat2$sigmasq_m_beta = sigmasq_m_beta
if(!print.only){
    model1.5.mat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.5.4.stan",data=data1.mat2,iter=niterations,chains=0)
...
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="maternal"
    ...
    data1.pat2$sigmasq_m_beta = sigmasq_m_beta
    if(!print.only){
        model1.5.pat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.5.4.stan",data=data1.pat2,iter=niterations,chains=0)
...
#              model1.5.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.5.4.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","omega","mu_m","sigmasq_m","exp_a0"))
        ...
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.pat,permuted=T)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.",myname,".posteriors.beta_Age.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.",myname,".posteriors.mu_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
      if(myname=="maternal"){my.ylim=1.6}else {my.ylim=1.6}
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.",myname,".posteriors.sigmasq_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.",myname,".posteriors.omega.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2,lwd=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
...
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.cohort_specific_omega.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.cohort_specific_omega.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="maternal"
    ...
    if(!print.only){
        ...
        print(model1.5.pat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.cohort_specific_omega.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.cohort_specific_omega.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.pat,permuted=T)
mysim.model2.pat = mysim
    sum(mysim.model2.pat$beta_Age>0)/length(mysim.model2.pat$beta_Age)
...
#pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.cohort_specific_omega.",myname,".posteriors.beta_Age.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.cohort_specific_omega.",myname,".posteriors.all_parameters.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=10,width=10)
...
#dev.off()
#pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.cohort_specific_omega.",myname,".posteriors.mu_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
#dev.off()
 #   pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.cohort_specific_omega.",myname,".posteriors.sigmasq_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
if(myname=="maternal"){
    my.ylim=3
    my.xlim=4
}else{
...
#dev.off()
#pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.cohort_specific_omega.",myname,".posteriors.omega.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
#    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
    ...
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==55){
        myname="uniform_priors_on_beta_Age.maternal"
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==57){
        myname="uniform_priors_on_mu_m_cohort.maternal"
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==59){
        myname="uniform_priors_on_tau.maternal"
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==61){
        myname="uniform_priors_on_sigma_m.maternal"
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.mat.including_alpha.RData"))
    }
} else{
    if(argv[1]==47){
        myname="uniform_priors.maternal"
             load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors.all_chains.mat.including_alpha.RData")
        }
    if(argv[1]==55){
        myname="uniform_priors_on_beta_Age.maternal"
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==57){
        myname="uniform_priors_on_mu_m_cohort.maternal"
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.mat.including_alpha.RData"))
    }
      if(argv[1]==59){
          myname="uniform_priors_on_tau.maternal"
          load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.mat.including_alpha.RData"))
      }
        if(argv[1]==61){
            myname="uniform_priors_on_sigma_m.maternal"
            load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.mat.including_alpha.RData"))
        }
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
...
#    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
    ...
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
                                        #    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors.all_chains.pat.including_alpha.RData")
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==56){
        myname="uniform_priors_on_beta_Age.paternal"
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==58){
        myname="uniform_priors_on_mu_m_cohort.paternal"
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==60){
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.pat.including_alpha.RData"))
        myname="uniform_priors_on_tau.paternal"
    }
    if(argv[1]==62){
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.pat.including_alpha.RData"))
   ...
   if(argv[1]==48){
       myname="uniform_priors.paternal"
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData")
...
#pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.uniform_priors.v4.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
        if(argv[1] %in% c(47,55,57,59,61)){
        my.ylim=0.6
        my.xlim=c(32,46)
    }else {
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
        if(argv[1] %in% c(47,55,57,59,61)){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.tausq.pdf"),height=5,width=5)
...
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.uniform_priors.all_chains.mat.including_alpha.RData"))
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.uniform_priors.all_chains.mat.including_alpha.RData")
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="maternal"
...
#      model1.5.pat <- sflist2stanfit(model1.5.pat.list)
      model1.5.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.5.4.uniform_priors.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","omega","mu_m","sigmasq_m","exp_a0"))
        print(model1.5.pat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.uniform_priors.all_chains.pat.including_alpha.RData"))
    } else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.uniform_priors.all_chains.pat.including_alpha.RData"))
}
    mysim<-extract(model1.5.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="paternal"
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.uniform_priors.v4.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
abline(v=0,lwd=2)
dev.off()


pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.uniform_priors.v4.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
if(myname=="maternal"){
    my.ylim=1.7
} else {
    my.ylim=1.7
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.uniform_priors.v4.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=1
        my.xlim=10
    }else {
...
dev.off()
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.5.4.uniform_priors.v4.",myname,".posteriors.omega.pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
...
#    model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data1.mat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0")))
 #   model1.6.mat <- sflist2stanfit(model1.6.mat.list)
   model1.6.mat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.t_distribution_on_alphas.stan",data=data1.mat2,iter=niterations,chains=4,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0"))             
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".RData"))
} else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="maternal"
...
#    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
    ...
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas.df_",df.alpha,".RData"))
}else{
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas.df_",df.alpha,".RData"))
 }
    mysim<-extract(model1.6.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    myname="paternal"
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.beta_Age.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    if(myname=="maternal"){
    ...
    dev.off()
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.mu_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.sigmasq_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.tausq.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),xlab="tausq",main="Posterior for tausq",lwd=2)
    lines(density(rigamma(niterations,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
...
#    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
    ...
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".RData"))
}else {
...
#    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
   model1.6.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.t_distribution_on_alphas_and_Y.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0"))
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
         save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas_and_Y.df_",df.alpha,".RData"))
} else {
load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas_and_Y.df_",df.alpha,".RData"))
}
     mysim<-extract(model1.6.pat,permuted=T)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    if(myname=="maternal"){
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){my.ylim=0.6}else {my.ylim=0.7}
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    legend("topright",c(as.character(cohort.codes[order(cohort.codes[,1]),2]),"prior"),col=c(mycols[as.character(cohort.codes[,2])],"black"),lty=c(rep(1,nrow(cohort.codes)),2),lwd=c(rep(2,nrow(cohort.codes)),3),cex=0.5)
    dev.off()
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),xlab="tausq",main="Posterior for tausq",lwd=2)
    lines(density(rigamma(niterations,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
...
##    mean_alpha_prior=38
    ...
    data1.mat2$sigmasq_mu_m_prior = sigmasq_mu_m_prior
    if(!print.only){   
#    model1.6.mat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.with_agesq_term.stan",data=data1.mat2,iter=niterations,chains=0)
#    model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data1.mat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","beta_Agesq","tausq","mu_m","sigmasq_m","a0")))
#    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
      model1.6.mat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.with_agesq_term.stan",data=data1.mat2,iter=niterations,chains=4,pars=c("beta_Age","beta_Agesq","tausq","mu_m","sigmasq_m","a0"))
    print(model1.6.mat,pars=c("beta_Age","beta_Agesq","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.with_agesq_term.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.with_agesq_term.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,                ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
    ...
    data1.pat2$df_alpha = df.alpha
     ...
     data1.pat2$sigmasq_mu_m_prior=sigmasq_mu_m_prior
     if(!print.only){
#    model1.6.pat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.with_agesq_term.stan",data=data1.pat2,iter=niterations,chains=0)
#    model1.6.pat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.pat.compiled, data = data1.pat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","beta_Agesq","tausq","mu_m","sigmasq_m","a0")))
#    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
           model1.6.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.with_agesq_term.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","beta_Agesq","tausq","mu_m","sigmasq_m","a0"))
       print(model1.6.pat,pars=c("beta_Age","beta_Agesq","tausq","sigmasq_m","mu_m"),digits=4)
     save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
 }
     mysim<-extract(model1.6.pat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.2.",myname,".posteriors.beta_Agesq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
#        model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data0.mat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0","beta_global","sigmasq_global")))
    ...
    if(!print.only){ 
#    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.",myname,".all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.mat,permuted=T)
    ...
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.",myname,".all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",                sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.mat,permuted=T)
}
...
#             model1.6.pat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.pat.compiled, data = data0.pat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0")))
     ...
     if(!print.only){
#         model1.6.pat <- sflist2stanfit(model1.6.pat.list)
         save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.",myname,".all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
         mysim<-extract(model1.6.pat,permuted=T)
    if("beta_global" %in% names(mysim)){
        ...
        print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
         ...
         load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.",myname,".all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
         mysim<-extract(model1.6.pat,permuted=T)
     }

 }
if(FALSE){
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/",myname,".traceplots.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    my.ylim=100
    if(!"beta_global" %in% names(mysim)){
        plot(density(mysim$beta_Age),xlim=c(-0.5,0.5),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
        abline(v=0,lwd=2)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    plot(density(mysim$sigmasq_m),xlab="sigmasq_m",main="Posterior for sigmasq_m",lwd=2)
    lines(density(rigamma(niterations,sigmasq_m_alpha,sigmasq_m_beta)),lwd=3,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()

    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),lwd=2,main="Posterior for tausq",xlab="tausq")
    lines(density(rigamma(niterations,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lty=c(1,2),lwd=2)
    dev.off()
...
#model3.2.mat <- sflist2stanfit(model3.2.mat.list)
    model3.2.mat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model3.2.adjusted_priors.different_link.stan",data=data2.mat2,iter=niterations,chains=4,pars=c("beta_Age","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0"))
save(model3.2.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.model3.2.adjusted_priors.different_link.all_chains.mat.including_alpha.RData"))
print(model3.2.mat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
} else {
load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.model3.2.adjusted_priors.different_link.all_chains.mat.including_alpha.RData")
print(model3.2.mat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
}
...
#    model3.2.pat <- sflist2stanfit(model3.2.pat.list)
    model3.2.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model3.2.adjusted_priors.different_link.stan",data=data2.pat2,iter=niterations,chains=4,pars=c("beta_Age","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0"))
    save(model3.2.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.model3.2.adjusted_priors.different_link.all_chains.pat.including_alpha.RData"))
    print(model3.2.pat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.model3.2.adjusted_priors.different_link.all_chains.pat.including_alpha.RData")
}
    mysim<-extract(model3.2.pat,permuted=T)
    parent="adjusted_priors.paternal"
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_3.more_stringent.no_GPC.txt",header=T,stringsAsFactors=F)
    ...
    names(mylwd)=c("infor.2gen.2parents","infor.3gen.2parents","noninfor.2kids.2gen.2parents","infor.2gen.1parent","infor.3gen.1parent","noninfor.2kids.2gen.1parent")
        mypch=c(NA,NA,NA,19,19,19)
    names(mypch)=c("infor.2gen.2parents","infor.3gen.2parents","noninfor.2kids.2gen.2parents","infor.2gen.1parent","infor.3gen.1parent","noninfor.2kids.2gen.1parent")
 pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model3.2.different_link.",parent,".posteriors.all_parameters.pdf"),height=8*3,width=4*3)
par(mfrow=c(8,4))
...
if(!print.only){
 ...
 print(model1.6.mat,pars=c("beta_Age","beta_global","sigmasq_global","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.ART_separated.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
} else {
  load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.ART_separated.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.ART_separated.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.all_parameters.pdf"),height=20,width=4)
...
if(!print.only){
 ...
 print(model1.6.mat,pars=c("beta_Age","beta_global","sigmasq_global","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.NTR_pill_separated.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
} else {
  load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.NTR_pill_separated.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model1.6.NTR_pill_separated.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.all_parameters.pdf"),height=20,width=4)
par(mfrow=c(5,1),oma=c(0,0,1,0),mar=c(5,4,2,1))
...
print(model1.5.mat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
  ...
  load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData")
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T)
...
model3.2.mat <- sflist2stanfit(model3.2.mat.list)
save(model3.2.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.model3.2.",name,".RData"))
print(model3.2.mat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
} else {
load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.model3.2.",name,".RData"))
print(model3.2.mat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
}
mysim<-extract(model3.2.mat,permuted=T)
parent="adjusted_priors.maternal"
...
if(!print.only){
    ...
    model3.2.pat <- sflist2stanfit(model3.2.pat.list)
    save(model3.2.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.model3.2.",name,".RData"))
    print(model3.2.pat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
} else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.model3.2.",name,".RData"))
}
 ...
 pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/model3.2.",name,".posteriors.all_parameters.pdf"),height=8*3,width=4*3)
par(mfrow=c(8,4),oma=c(0,0,1,0),mar=c(5,4,2,1))
...
if(!print.only){
      model1.6.mat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.stan",data=data1.mat2,iter=niterations,chains=4,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0"))
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.mat.informative_nuclear_families.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.mat.informative_nuclear_families.including_alpha.mu_m_N_",
                mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.informative_nuclear_families_only.more_stringent.no_GPC.txt",header=T)
    ...
    data1.pat2$cohort_by_family = cohort_by_family
     ...
     if(!print.only){
           model1.6.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0"))
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
     save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.pat.informative_nuclear_families.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
} else {
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.6.2.all_chains.pat.informative_nuclear_families.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",
...
if(!print.only){
      model1.5.mat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.5.4.stan",data=data1.mat2,iter=niterations,chains=4,pars=c("beta_Age","omega","mu_m","sigmasq_m","exp_a0"))
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.all_chains.mat.informative_nuclear_families.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.all_chains.mat.informative_nuclear_families.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.mat,permuted=T)
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.informative_nuclear_families_only.more_stringent.no_GPC.txt",header=T)
    myname="maternal.informative_nuclear_families"
    ...
    if(!print.only){
              model1.5.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.5.4.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","omega","mu_m","sigmasq_m","exp_a0"))
        print(model1.5.pat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.all_chains.pat.informative_nuclear_families.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC.raw_counts/RSTAN.modell1.5.4.all_chains.pat.informative_nuclear_families.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.pat,permuted=T)
mysim.model2.pat = mysim
    sum(mysim.model2.pat$beta_Age>0)/length(mysim.model2.pat$beta_Age)
