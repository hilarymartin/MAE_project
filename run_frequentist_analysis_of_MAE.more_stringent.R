...
write.table(nftools.mat.adjusted.spearman.by.cohort,"frequentist_analysis/more_stringent/nftools.mat.adjusted.spearman.by.cohort.txt",quote=F,sep="\t")
write.table(duohmm.mat.adjusted.spearman.by.cohort,"frequentist_analysis/more_stringent/duohmm.mat.adjusted.spearman.by.cohort.txt",quote=F,sep="\t")
write.table(duohmm2.mat.adjusted.spearman.by.cohort,"frequentist_analysis/more_stringent/duohmm_in_nftools.mat.adjusted.spearman.by.cohort.txt",quote=F,sep="\t")

write.table(summary.nftools.mat.results.by.cohort,"frequentist_analysis/more_stringent/nftools.mat.lme.results.by.cohort.txt",quote=F,sep="\t")
write.table(summary.duohmm.mat.results.by.cohort,"frequentist_analysis/more_stringent/duohmm.mat.lme.results.by.cohort.txt",quote=F,sep="\t")
write.table(summary.duohmm2.mat.results.by.cohort,"frequentist_analysis/more_stringent/duohmm_in_nftools.mat.lme.results.by.cohort.txt",quote=F,sep="\t")

write.table(summary.nftools.mat.adjusted.results.by.cohort,"frequentist_analysis/more_stringent/nftools.mat.lm_on_adjusted_counts.by.cohort.txt",quote=F,sep="\t")
write.table(summary.duohmm.mat.adjusted.results.by.cohort,"frequentist_analysis/more_stringent/duohmm.mat.lm_on_adjusted_counts.by.cohort.txt",quote=F,sep="\t")
write.table(summary.duohmm2.mat.adjusted.results.by.cohort,"frequentist_analysis/more_stringent/duohmm_in_nftools.mat.lm_on_adjusted_counts.by.cohort.txt",quote=F,sep="\t")


write.table(nftools.pat.adjusted.spearman.by.cohort,"frequentist_analysis/more_stringent/nftools.pat.adjusted.spearman.by.cohort.txt",quote=F,sep="\t")
write.table(duohmm.pat.adjusted.spearman.by.cohort,"frequentist_analysis/more_stringent/duohmm.pat.adjusted.spearman.by.cohort.txt",quote=F,sep="\t")
write.table(duohmm2.pat.adjusted.spearman.by.cohort,"frequentist_analysis/more_stringent/duohmm_in_nftools.pat.adjusted.spearman.by.cohort.txt",quote=F,sep="\t")

write.table(summary.nftools.pat.results.by.cohort,"frequentist_analysis/more_stringent/nftools.pat.lme.results.by.cohort.txt",quote=F,sep="\t")
write.table(summary.duohmm.pat.results.by.cohort,"frequentist_analysis/more_stringent/duohmm.pat.lme.results.by.cohort.txt",quote=F,sep="\t")
write.table(summary.duohmm2.pat.results.by.cohort,"frequentist_analysis/more_stringent/duohmm_in_nftools.pat.lme.results.by.cohort.txt",quote=F,sep="\t")

write.table(summary.nftools.pat.adjusted.results.by.cohort,"frequentist_analysis/more_stringent/nftools.pat.lm_on_adjusted_counts.by.cohort.txt",quote=F,sep="\t")
write.table(summary.duohmm.pat.adjusted.results.by.cohort,"frequentist_analysis/more_stringent/duohmm.pat.lm_on_adjusted_counts.by.cohort.txt",quote=F,sep="\t")
write.table(summary.duohmm2.pat.adjusted.results.by.cohort,"frequentist_analysis/more_stringent/duohmm_in_nftools.pat.lm_on_adjusted_counts.by.cohort.txt",quote=F,sep="\t")

save.image("frequentist_analysis/more_stringent/frequentist_analysis_of_MAE.RData")
