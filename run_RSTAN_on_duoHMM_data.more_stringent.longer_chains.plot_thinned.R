...
#        model3.mat <- sflist2stanfit(model3.mat.list)
 model3.mat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model3.v2.adjusted_priors.stan",data=data2.mat2,iter=niterations,chains=4,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0"))
        save(model3.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.model3.adjusted_priors.all_chains.mat.including_alpha.RData"))
        print(model3.mat,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
    } else {
        load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.model3.adjusted_priors.all_chains.mat.including_alpha.RData")
    }
    mysim<-extract(model3.mat,permuted=F)
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
...
#        model3.pat.compiled = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model3.v2.adjusted_priors.stan",data=data2.pat2,iter=10,chains=0,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0"))
 ...
 #       model3.pat <- sflist2stanfit(model3.pat.list)
   model3.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model3.v2.adjusted_priors.stan",data=data2.pat2,iter=niterations,chains=4,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","omega","mu_m","sigmasq_m","exp_a0" ))
        save(model3.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.model3.adjusted_priors.all_chains.pat.including_alpha.RData"))
        print(model3.pat,pars=c("beta_Age","beta_global","sigmasq_global","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
    } else {
        load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.model3.adjusted_priors.all_chains.pat.including_alpha.RData")
    }
    mysim<-extract(model3.pat,permuted=F)
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
...
cohort.codes=cohort.codes[order(cohort.codes[,1]),]
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.",parent,".posteriors.beta_Age.pdf"),height=5,width=5)
    my.ylim=32
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.",parent,".posteriors.p.pdf"),height=5,width=5)
...
dev.off()
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.",parent,".posteriors.sigmasq_global.pdf"),height=5,width=5)
...
lines(rigamma(niterations,3,0.1),lty=2,lwd=2)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.",parent,".posteriors.omega.pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.",parent,".posteriors.mu_m.pdf"),height=5,width=5)
...
save(model3.2.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.model3.2.adjusted_priors.all_chains.mat.including_alpha.RData"))
} else {
...
mysim<-extract(model3.2.mat,permuted=F)
mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
mysim=list()
for(name in c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega")){
  index=grep(name,unlist(dimnames(mysim2)[3]))
if(length(index)==1){
  mysim[[name]] = c(mysim2[,,name])
} else {
...
save(mysim,"/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.model3.2.adjusted_priors.all_chains.mat.including_alpha.thinned.RData")

monitor(mysim2[,,unlist(sapply(c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),function(x){grep(x,unlist(dimnames(mysim2)[3]))}))],digits=4)
...
#    model3.2.pat <- sflist2stanfit(model3.2.pat.list)
    ...
    save(model3.2.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.model3.2.adjusted_priors.all_chains.pat.including_alpha.RData"))
    print(model3.2.pat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.model3.2.adjusted_priors.all_chains.pat.including_alpha.RData")
}
    mysim<-extract(model3.2.pat,permuted=F)
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
for(name in c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega")){
  index=grep(name,unlist(dimnames(mysim2)[3]))
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.2.",parent,".posteriors.all_parameters.pdf"),height=8*3,width=4*3)
par(mfrow=c(8,4))
#    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.2.",parent,".posteriors.beta_Age.pdf"),height=2.5,width=2.5)
...
#pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.2.",parent,".posteriors.sigmasq_m.pdf"),height=2.5,width=2.5)
...
#dev.off()
 ...
 #   pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.2.",parent,".posteriors.omega.pdf"),height=2.5,width=2.5)
    plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
    lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2,lwd=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
 #   dev.off()
    
  #  pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.2.",parent,".posteriors.mu_m.pdf"),height=2.5,width=2.5)
    plot(density(mysim$mu_m),main="Posterior for mu_m",lwd=2,xlab="mu_m")
    curve(dnorm(x,36,sqrt(6 )),lwd=2,lty=2,add=T)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
  #  dev.off()
...
#    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.2.",parent,".posteriors.p.pdf"),height=5,width=5)
#    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.2.",parent,".posteriors.p.all_cohorts_combined.pdf"),height=4*2.5,width=7*2.5)
#par(mfrow=c(4,7))
mylabels=c(paste(c("informative, 2 generations","informative, 3 generations","uninformative, 2 kids"),"both parents",sep=", "),paste(c("informative, 2 generations","informative, 3 generations","uninformative, 2 kids"),"1 parent",sep=", "))
names(mylabels)=c("infor.2gen.2parents","infor.3gen.2parents","noninfor.2kids.2gen.2parents","infor.2gen.1parent","infor.3gen.1parent","noninfor.2kids.2gen.1parent")
...
#    model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data1.mat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","beta_global","sigmasq_global","tausq","mu_m","sigmasq_m","a0")))
 ...
 print(model1.6.mat,pars=c("beta_Age","beta_global","sigmasq_global","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
} else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,
                ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=F)
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
for(name in c("beta_Age","beta_global","sigmasq_global","tausq","mu_m","sigmasq_m")){
  index=grep(name,unlist(dimnames(mysim2)[3]))
if(length(index)==1){
  mysim[[name]] = c(mysim2[,,name])
} else {
...
mysim[[name]]=cbind(mysim[[name]],c(mysim2[,,j]))
    ...
    monitor(mysim2[,,unlist(sapply(c("beta_Age","beta_global","sigmasq_global","tausq","sigmasq_m","mu_m"),function(x){grep(x,unlist(dimnames(mysim2)[3]))}))],digits=4)
...
#    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
 model1.6.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","beta_global","sigmasq_global","tausq","mu_m","sigmasq_m","a0"))
    ...
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.pat,permuted=F)
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
for(name in c("beta_Age","beta_global","sigmasq_global","tausq","mu_m","sigmasq_m")){
  index=grep(name,unlist(dimnames(mysim2)[3]))
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.mu_m.pdf"),height=5,width=5)
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
    lines(density(rigamma(niterations,3,0.5)),lwd=2,lty=2)
legend("topright",c("posterior","prior"),lty=c(1,2),lwd=c(2,2))
dev.off()
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".",myname,".posteriors.tausq.pdf"),height=5,width=5)
...
print(model1.5.mat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData"))
} else {
  load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData"))
}
    mysim<-extract(model1.5.mat,permuted=F)
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
for(name in c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m")){
  index=grep(name,unlist(dimnames(mysim2)[3]))
if(length(index)==1){
  mysim[[name]] = c(mysim2[,,name])
} else {
...
mysim[[name]]=cbind(mysim[[name]],c(mysim2[,,j]))
    ...
    monitor(mysim2[,,unlist(sapply(c("beta_Age","beta_global","sigmasq_global","omega","sigmasq_m","mu_m"),function(x){grep(x,unlist(dimnames(mysim2)[3]))}))],digits=4)

  
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
    for(name in unlist(dimnames(mysim2)[3])){
        mysim[[name]] = c(mysim2[,,name])
    }
    monitor(mysim2[,,unlist(sapply(c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),function(x){grep(x,unlist(dimnames(mysim2)[3]))}))],digits=4)
...
print(model1.5.pat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData"))
} else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.all_chains.",myname,".including_alpha.RData"))
}
    mysim<-extract(model1.5.pat,permuted=F)
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
#my.ylim=55
for(i in 1:ncol(mysim$beta_Age)){
    if(i==1){
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
lines(rigamma(niterations,3,0.1),add=T,lty=2,lwd=2)
dev.off()

pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
#if(myname=="maternal"){
#  my.ylim=3
#    my.xlim=4
#}else{
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.",myname,".posteriors.omega.pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2,lwd=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
...
print(model1.5.mat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
   save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.different_link.all_chains.",myname,".including_alpha.RData"))
} else {
  load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.different_link.all_chains.",myname,".including_alpha.RData")
}
    mysim<-extract(model1.5.mat,permuted=F)
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
...
#    model1.5.pat <- sflist2stanfit(model1.5.pat.list)
 ...
 print(model1.5.pat,pars=c("beta_Age","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.different_link.all_chains.",myname,".including_alpha.RData"))
 } else {
   load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.different_link.all_chains.",myname,".including_alpha.RData")
}
  mysim<-extract(model1.5.pat,permuted=F)
...
mysim[[name]]=cbind(mysim[[name]],c(mysim2[,,j]))
  ...
  monitor(mysim2[,,unlist(sapply(c("beta_Age","beta_global","sigmasq_global","omega","sigmasq_m","mu_m"),function(x){grep(x,unlist(dimnames(mysim2)[3]))}))],digits=4)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.different_link.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.different_link.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.different_link.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
#      if(myname=="maternal"){my.ylim=1.6}else {my.ylim=1.6}
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
 #           plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.different_link.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
#if(myname=="maternal"){
#  my.ylim=3
#    my.xlim=4
#}else{
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.different_link.",myname,".posteriors.omega.pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2,lwd=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
...
if(!print.only){
 ...
 print(model1.5.mat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.different_link.weaker_priors.all_chains.mat.including_alpha.RData"))
} else {
load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.different_link.weaker_priors.all_chains.mat.including_alpha.RData")
}
...
print(model1.5.pat,pars=c("beta_Age","beta_Cohort","beta_global","sigmasq_global","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.different_link.weaker_priors.all_chains.pat.including_alpha.RData"))
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.different_link.weaker_priors.all_chains.pat.including_alpha.RData")
}
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.different_link.weaker_priors.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.different_link.weaker_priors.",myname,".posteriors.sigmasq_global.pdf"),height=5,width=5)
  plot(density(mysim$sigmasq_global),xlab="sigmasq_global",main="Posterior for sigmasq_global",lwd=2)
dev.off()
}
}
...
#    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
    ...
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.all_chains.mat.including_alpha.mu_m_N_",
...
for(name in c("beta_Age","tausq","sigmasq_m","mu_m")){
  index=grep(name,unlist(dimnames(mysim2)[3]))
if(length(index)==1){
  mysim[[name]] = c(mysim2[,,name])
} else {
...
mysim[[name]]=cbind(mysim[[name]],c(mysim2[,,j]))
    ...
    monitor(mysim2[,,unlist(sapply(c("beta_Age","tausq","sigmasq_m","mu_m"),function(x){grep(x,unlist(dimnames(mysim2)[3]))}))],digits=4)
...
if(FALSE){
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".traceplots.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),
    height=5,width=5)
    my.ylim=100
#    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),
        height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,
    ...
    legend("topright",c(as.character(cohort.codes[order(cohort.codes[,1]),2]),"prior","empirical variance in parent means"),col=c(mycols[as.character(cohort.codes[,2])],"black","black"),lty=c(rep(1,nrow(cohort.codes)),2,2),
           lwd=c(rep(2,nrow(cohort.codes)),3,1),cex=0.5)
    dev.off()

    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf")
        ,height=5,width=5)
...
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.4.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.4.all_chains.mat.including_alpha.sigmasq_m_IG_",
...
for(name in c("beta_Age","omega","sigmasq_m","mu_m")){
  index=grep(name,unlist(dimnames(mysim2)[3]))
if(length(index)==1){
  mysim[[name]] = c(mysim2[,,name])
} else {
...
mysim[[name]]=cbind(mysim[[name]],c(mysim2[,,j]))
    ...
    monitor(mysim2[,,unlist(sapply(c("beta_Age","omega","sigmasq_m","mu_m"),function(x){grep(x,unlist(dimnames(mysim2)[3]))}))],digits=4)
...
#        model1.5.pat <- sflist2stanfit(model1.5.pat.list)
        ...
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.4.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.4.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.5.pat,permuted=F)
            mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.4.",myname,".posteriors.beta_Age.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.4.",myname,".posteriors.mu_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
      if(myname=="maternal"){my.ylim=1.6}else {my.ylim=1.6}
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.4.",myname,".posteriors.sigmasq_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.4.",myname,".posteriors.omega.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2,lwd=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
...
#    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
    ...
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==55){
        myname="uniform_priors_on_beta_Age.maternal"
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==57){
        myname="uniform_priors_on_mu_m_cohort.maternal"
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==59){
        myname="uniform_priors_on_tau.maternal"
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==61){
        myname="uniform_priors_on_sigma_m.maternal"
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.mat.including_alpha.RData"))
    }
} else{
    if(argv[1]==47){
        myname="uniform_priors.maternal"
             load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors.all_chains.mat.including_alpha.RData")
        }
    if(argv[1]==55){
        myname="uniform_priors_on_beta_Age.maternal"
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.mat.including_alpha.RData"))
    }
    if(argv[1]==57){
        myname="uniform_priors_on_mu_m_cohort.maternal"
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.mat.including_alpha.RData"))
    }
      if(argv[1]==59){
          myname="uniform_priors_on_tau.maternal"
          load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.mat.including_alpha.RData"))
      }
        if(argv[1]==61){
            myname="uniform_priors_on_sigma_m.maternal"
            load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.mat.including_alpha.RData"))
        }
}
    mysim<-extract(model1.6.mat,permuted=F)
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
...
#    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
    ...
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
                                        #    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors.all_chains.pat.including_alpha.RData")
#    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==56){
        myname="uniform_priors_on_beta_Age.paternal"
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_beta_Age.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==58){
        myname="uniform_priors_on_mu_m_cohort.paternal"
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_mu_m_cohort.all_chains.pat.including_alpha.RData"))
    }
    if(argv[1]==60){
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_tau.all_chains.pat.including_alpha.RData"))
        myname="uniform_priors_on_tau.paternal"
    }
    if(argv[1]==62){
        save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.pat.including_alpha.RData"))
#        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors_on_sigma_m.all_chains.pat.including_alpha.RData"))
   ...
   if(argv[1]==48){
       myname="uniform_priors.paternal"
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.uniform_priors.v4.all_chains.pat.including_alpha.RData")
...
#pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.uniform_priors.v4.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
        if(argv[1] %in% c(47,55,57,59,61)){
        my.ylim=0.6
        my.xlim=c(32,46)
    }else {
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
        if(argv[1] %in% c(47,55,57,59,61)){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.tausq.pdf"),height=5,width=5)
...
print(model1.5.mat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
    save(model1.5.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.4.uniform_priors.all_chains.mat.including_alpha.RData"))
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.4.uniform_priors.all_chains.mat.including_alpha.RData")
}
    mysim<-extract(model1.5.mat,permuted=F)
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
...
mysim[[name]]=cbind(mysim[[name]],c(mysim2[,,j]))
    ...
    monitor(mysim2[,,unlist(sapply(c("beta_Age","omega","mu_m","sigmasq_m"),function(x){grep(x,unlist(dimnames(mysim2)[3]))}))],digits=4)
...
#      model1.5.pat <- sflist2stanfit(model1.5.pat.list)
      model1.5.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.5.4.uniform_priors.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","omega","mu_m","sigmasq_m","exp_a0"))
        print(model1.5.pat,pars=c("beta_Age","omega","mu_m","sigmasq_m"),digits=4)
        save(model1.5.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.4.uniform_priors.all_chains.pat.including_alpha.RData"))
    } else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.5.4.uniform_priors.all_chains.pat.including_alpha.RData"))
}
    mysim<-extract(model1.5.pat,permuted=F)
        mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.4.uniform_priors.v4.",myname,".posteriors.beta_Age.pdf"),height=5,width=5)
plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
abline(v=0,lwd=2)
dev.off()


pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.4.uniform_priors.v4.",myname,".posteriors.mu_m.pdf"),height=5,width=5)
if(myname=="maternal"){
    my.ylim=1.7
} else {
    my.ylim=1.7
...
dev.off()
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.4.uniform_priors.v4.",myname,".posteriors.sigmasq_m.pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=1
        my.xlim=10
    }else {
...
dev.off()
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.5.4.uniform_priors.v4.",myname,".posteriors.omega.pdf"),height=5,width=5)
plot(density(mysim$omega),main="Posterior for omega",lwd=2,xlab="omega")
lines(1/seq(from=0,to=1,by=0.01),seq(from=0,to=1,by=0.01),type="l",lty=2)
legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
dev.off()
...
#    model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data1.mat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0")))
 #   model1.6.mat <- sflist2stanfit(model1.6.mat.list)
   model1.6.mat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.t_distribution_on_alphas.stan",data=data1.mat2,iter=niterations,chains=4,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0"))             
    print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".RData"))
} else {
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.all_chains.mat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=F)
        mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
...
mysim[[name]]=cbind(mysim[[name]],c(mysim2[,,j]))
    ...
    monitor(mysim2[,,unlist(sapply(c("beta_Age","tausq","mu_m","sigmasq_m"),function(x){grep(x,unlist(dimnames(mysim2)[3]))}))],digits=4)
...
#    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
    ...
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
    save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas.df_",df.alpha,".RData"))
}else{
     load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas.df_",df.alpha,".RData"))
 }
    mysim<-extract(model1.6.pat,permuted=F)
        mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.beta_Age.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    if(myname=="maternal"){
    ...
    dev.off()
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.mu_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.sigmasq_m.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.tausq.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas.df_",df.alpha,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),xlab="tausq",main="Posterior for tausq",lwd=2)
    lines(density(rigamma(niterations,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
...
#    model1.6.pat <- sflist2stanfit(model1.6.pat.list)
   model1.6.pat = stan(file = "/well/donnelly/hilary/maternal_age_and_recombination/bin/RSTAN.model1.6.2.t_distribution_on_alphas_and_Y.stan",data=data1.pat2,iter=niterations,chains=4,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0"))
    print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
         save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas_and_Y.df_",df.alpha,".RData"))
} else {
load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distributions_on_alphas_and_Y.df_",df.alpha,".RData"))
}
     mysim<-extract(model1.6.pat,permuted=F)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    my.ylim=100
    plot(density(mysim$beta_Age),xlim=range(mysim$beta_Age),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    if(myname=="maternal"){
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){my.ylim=0.6}else {my.ylim=0.7}
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.2
        my.xlim=100
    }else {
    ...
    legend("topright",c(as.character(cohort.codes[order(cohort.codes[,1]),2]),"prior"),col=c(mycols[as.character(cohort.codes[,2])],"black"),lty=c(rep(1,nrow(cohort.codes)),2),lwd=c(rep(2,nrow(cohort.codes)),3),cex=0.5)
    dev.off()
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".t_distribution_on_alphas_and_Y.df_",df.alpha,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),xlab="tausq",main="Posterior for tausq",lwd=2)
    lines(density(rigamma(niterations,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()
...
#    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
    ...
    print(model1.6.mat,pars=c("beta_Age","beta_Agesq","tausq","sigmasq_m","mu_m"),digits=4)
       save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.with_agesq_term.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}else{
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.modell1.6.2.with_agesq_term.all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,                ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
}
    mysim<-extract(model1.6.mat,permuted=F)
            mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
for(name in c("beta_Age","beta_Agesq","tausq","sigmasq_m","mu_m")){
  index=grep(name,unlist(dimnames(mysim2)[3]))
if(length(index)==1){
  mysim[[name]] = c(mysim2[,,name])
} else {
...
mysim[[name]]=cbind(mysim[[name]],c(mysim2[,,j]))
    ...
    monitor(mysim2[,,unlist(sapply(c("beta_Age","beta_Agesq","tausq","mu_m","sigmasq_m"),function(x){grep(x,unlist(dimnames(mysim2)[3]))}))],digits=4)
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    my.ylim=100
        plot(density(mysim$beta_Age),xlim=c(-0.5,0.5),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
    abline(v=0,lwd=2)
    curve(dnorm(x,0,1),lty=2,lwd=2,add=T)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.beta_Agesq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    if(myname=="maternal"){my.ylim=0.4}else {my.ylim=0.7}
    for(i in 1:ncol(mysim$mu_m)){
        if(i==1){
            plot(density(mysim$mu_m[,i]),xlim=range(mysim$mu_m),xlab="mu_m",main="Posterior for mu_m",col=mycols[as.character(cohort.codes[i,2])],lwd=2,ylim=c(0,my.ylim))
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    if(myname=="maternal"){
        my.ylim=0.17
        my.xlim=100
    }else {
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model1.6.2.",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),lwd=2,main="Posterior for tausq",xlab="tausq")
    lines(density(rigamma(niterations,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lty=c(1,2),lwd=2)
    dev.off()
...
#          model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data1.mat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0","beta_global","sigmasq_global")))
    ...
    if(argv[1]==73){
        ...
        cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.informative_nuclear_families_only.more_stringent.txt",header=T)
if(!print.only){
...
#        model1.6.mat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.mat.compiled, data = data0.mat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0","beta_global","sigmasq_global")))
    ...
    if(!print.only){ 
#    model1.6.mat <- sflist2stanfit(model1.6.mat.list)
        save(model1.6.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.",myname,".all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.mat,permuted=F)
                    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
    if("beta_global" %in% names(mysim)){
        print(model1.6.mat,pars=c("beta_Age","tausq","sigmasq_m","mu_m","beta_global","sigmasq_global"),digits=4)
        monitor(mysim2[,,unlist(sapply(c("beta_Age","tausq","mu_m","sigmasq_m","beta_global","sigmasq_global"),function(x){grep(x,unlist(dimnames(mysim2)[3]))}))],digits=4)
for(name in c("beta_Age","tausq","sigmasq_m","mu_m","beta_global","sigmasq_global")){
  index=grep(name,unlist(dimnames(mysim2)[3]))
if(length(index)==1){
  mysim[[name]] = c(mysim2[,,name])
} else {
...
mysim[[name]]=cbind(mysim[[name]],c(mysim2[,,j]))
    ...
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.",myname,".all_chains.mat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior, ".sigmasq_m_IG_",                sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
    mysim<-extract(model1.6.mat,permuted=F)
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
...
#             model1.6.pat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.pat.compiled, data = data1.pat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0")))
     ...
     if(argv[1] ==74){
         ...
         cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.informative_nuclear_families_only.more_stringent.txt",header=T)
         if(!print.only){
...
#             model1.6.pat.list = mclapply(1:4, mc.cores = 4,function(i) stan(fit = model1.6.pat.compiled, data = data0.pat2,chains = 1, chain_id = i,iter=niterations,pars=c("beta_Age","tausq","mu_m","sigmasq_m","a0")))
     ...
     if(!print.only){
#         model1.6.pat <- sflist2stanfit(model1.6.pat.list)
         save(model1.6.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.",myname,".all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
         mysim<-extract(model1.6.pat,permuted=F)
    if("beta_global" %in% names(mysim)){
        ...
        print(model1.6.pat,pars=c("beta_Age","tausq","sigmasq_m","mu_m"),digits=4)
         ...
         load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.",myname,".all_chains.pat.including_alpha.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
         mysim<-extract(model1.6.pat,permuted=F)
             mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
    mysim=list()
...
if(FALSE){
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/",myname,".traceplots.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    traceplot(model1.6.mat,pars=c("beta_Age"),window=c(10^2,10^4))
    traceplot(model1.6.mat,pars=c("mu_m"),window=c(10^2,10^4))
    traceplot(model1.6.mat,pars=c("sigmasq_m"),window=c(10^2,10^4))
    traceplot(model1.6.mat,pars=c("tausq"),window=c(10^2,10^4))
...
pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/",myname,".posteriors.beta_Age.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    my.ylim=100
    if(!"beta_global" %in% names(mysim)){
        plot(density(mysim$beta_Age),xlim=c(-0.5,0.5),xlab="beta_Age",main="Posterior for beta_Age",lwd=2)
        abline(v=0,lwd=2)
    ...
    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/",myname,".posteriors.mu_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    ...
    dev.off()
        ...
        pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/",myname,".posteriors.sigmasq_m.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    plot(density(mysim$sigmasq_m),xlab="sigmasq_m",main="Posterior for sigmasq_m",lwd=2)
    lines(density(rigamma(niterations,sigmasq_m_alpha,sigmasq_m_beta)),lwd=3,lty=2)
    legend("topright",c("posterior","prior"),lwd=2,lty=c(1,2))
    dev.off()

    pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/",myname,".posteriors.tausq.mu_m_N_",mean_alpha_prior,"_",sigmasq_mu_m_prior,".sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".pdf"),height=5,width=5)
    plot(density(mysim$tausq),lwd=2,main="Posterior for tausq",xlab="tausq")
    lines(density(rigamma(niterations,2,70)),lwd=2,lty=2)
    legend("topright",c("posterior","prior"),lty=c(1,2),lwd=2)
    dev.off()
...
save(model3.2.mat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.model3.2.adjusted_priors.different_link.all_chains.mat.including_alpha.RData"))
print(model3.2.mat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
} else {
load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.model3.2.adjusted_priors.different_link.all_chains.mat.including_alpha.RData")
print(model3.2.mat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
}
...
#    model3.2.pat <- sflist2stanfit(model3.2.pat.list)
    ...
    save(model3.2.pat,file=paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.model3.2.adjusted_priors.different_link.all_chains.pat.including_alpha.RData"))
    print(model3.2.pat,pars=c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),digits=4)
} else {
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/longer_chains//RSTAN.model3.2.adjusted_priors.different_link.all_chains.pat.including_alpha.RData")
}
    mysim<-extract(model3.2.pat,permuted=F)
    mysim2 = mysim[which(1:50000 / 100 - 1:50000 %/% 100 ==0),,]
mysim=list()
...
monitor(mysim2[,,unlist(sapply(c("beta_Age","p_by_cohort","mu_m","sigmasq_m","omega"),function(x){grep(x,unlist(dimnames(mysim2)[3]))}))],digits=4)
    ...
    names(mylwd)=c("infor.2gen.2parents","infor.3gen.2parents","noninfor.2kids.2gen.2parents","infor.2gen.1parent","infor.3gen.1parent","noninfor.2kids.2gen.1parent")
        mypch=c(NA,NA,NA,19,19,19)
    names(mypch)=c("infor.2gen.2parents","infor.3gen.2parents","noninfor.2kids.2gen.2parents","infor.2gen.1parent","infor.3gen.1parent","noninfor.2kids.2gen.1parent")
 pdf(paste0("RSTAN_output_on_duoHMM_more_stringent/longer_chains/thinned/model3.2.different_link.",parent,".posteriors.all_parameters.pdf"),height=8*3,width=4*3)
par(mfrow=c(8,4))
