...
if(argv[1] ==45 | argv[1]==46){
    if(argv[1]==45){
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.all_chains.mat.including_alpha.sigmasq_m_IG_3_0.01.RData"))
        mysim<-extract(model1.5.mat,permuted=T)
        model="Model2.mat"
    } else {
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.all_chains.pat.including_alpha.sigmasq_m_IG_3_0.01.RData"))
...
if(argv[1] ==33 | argv[1]==34){
        cohort.specific=1
    if(argv[1]==33){
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.all_chains.maternal.mu_m_N_3.7_0.2.sigmasq_m_IG_3_0.01.including_alpha.RData"))
        mysim<-extract(model1.5.mat,permuted=T)
        model="Model2.2.mat"
    } else {
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.all_chains.paternal.mu_m_N_3.2_0.2.sigmasq_m_IG_3_0.01.including_alpha.RData"))
        mysim<-extract(model1.5.pat,permuted=T)
        model="Model2.2.pat"
    }
}
...
if(argv[1] ==5 | argv[1]==6){
    if(argv[1]==5){
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.cohort_specific_omega.all_chains.mat.including_alpha.sigmasq_m_IG_3_0.01.RData"))
        mysim<-extract(model1.5.mat,permuted=T)
        model="Model2.cohort_specific_omega.mat"
    } else{
        load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC_different_link_for_NB_changing_sigmasq_m_prior/RSTAN.modell1.5.4.cohort_specific_omega.all_chains.pat.including_alpha.sigmasq_m_IG_3_0.01.RData"))
        mysim<-extract(model1.5.pat,permuted=T)
