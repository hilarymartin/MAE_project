...
ata1.mat.nftools.wo.pill = data1.mat.nftools[data1.mat.nftools$child %in% duohmm.wo.pill$CHILD,]
...
results.wo.art = rbind(summary(duohmm.wo.art.lme.qtr610)$tTable[2,],summary(duohmm.wo.art.lme.NTR)$tTable[2,],summary(nftools.wo.art.lme.qtr610)$tTable[2,],
summary(nftools.wo.art.lme.NTR)$tTable[2,],summary(duohmm.wo.pill.lme.NTR)$tTable[2,],
...
data1.mat.duohmm$PARENT2=paste(data1.mat.duohmm$PARENT,data1.mat.duohmm$cohort,sep="-")
data1.pat.duohmm$PARENT2=paste(data1.pat.duohmm$PARENT,data1.pat.duohmm$cohort,sep="-")

all.duohmm.mat.lme=lme(nrec~age.at.birth,~1|as.factor(PARENT2),data=data1.mat.duohmm)
summary(all.duohmm.mat.lme)
all.duohmm.pat.lme=lme(nrec~age.at.birth,~1|as.factor(PARENT2),data=data1.pat.duohmm)
...
spearman.cor=cor.test(data1.adjusted.mat.duohmm[data1.adjusted.mat.duohmm$cohort==mat.cohorts[c],"adjusted.nrec"],
data1.adjusted.mat.duohmm[data1.adjusted.mat.duohmm$cohort==mat.cohorts[c],"adjusted.age"],method="spearman")
...
spearman.cor=cor.test(data1.adjusted.pat.duohmm[data1.adjusted.pat.duohmm$cohort==pat.cohorts[c],"adjusted.nrec"],
data1.adjusted.pat.duohmm[data1.adjusted.pat.duohmm$cohort==pat.cohorts[c],"adjusted.age"],method="spearman")
...
for(c in 1:length(mat.cohorts)){
    ...
    spearman.cor=cor.test(data1.adjusted.mat.duohmm2[data1.adjusted.mat.duohmm2$cohort==mat.cohorts[c],"adjusted.nrec"],
data1.adjusted.mat.duohmm2[data1.adjusted.mat.duohmm2$cohort==mat.cohorts[c],"adjusted.age"],
            method="spearman")
...
spearman.cor=cor.test(data1.adjusted.pat.duohmm2[data1.adjusted.pat.duohmm2$cohort==pat.cohorts[c],"adjusted.nrec"],
data1.adjusted.pat.duohmm2[data1.adjusted.pat.duohmm2$cohort==pat.cohorts[c],"adjusted.age"],
    method="spearman")
...
write.table(nftools.mat.adjusted.spearman.by.cohort,"frequentist_analysis/more_stringent/nftools.mat.adjusted.spearman.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")
write.table(duohmm.mat.adjusted.spearman.by.cohort,"frequentist_analysis/more_stringent/duohmm.mat.adjusted.spearman.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")
write.table(duohmm2.mat.adjusted.spearman.by.cohort,"frequentist_analysis/more_stringent/duohmm_in_nftools.mat.adjusted.spearman.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")

write.table(summary.nftools.mat.results.by.cohort,"frequentist_analysis/more_stringent/nftools.mat.lme.results.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")
write.table(summary.duohmm.mat.results.by.cohort,"frequentist_analysis/more_stringent/duohmm.mat.lme.results.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")
write.table(summary.duohmm2.mat.results.by.cohort,"frequentist_analysis/more_stringent/duohmm_in_nftools.mat.lme.results.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")

write.table(summary.nftools.mat.adjusted.results.by.cohort,"frequentist_analysis/more_stringent/nftools.mat.lm_on_adjusted_counts.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")
write.table(summary.duohmm.mat.adjusted.results.by.cohort,"frequentist_analysis/more_stringent/duohmm.mat.lm_on_adjusted_counts.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")
write.table(summary.duohmm2.mat.adjusted.results.by.cohort,"frequentist_analysis/more_stringent/duohmm_in_nftools.mat.lm_on_adjusted_counts.by.cohort.no_nkids_term.with_new_QTR.txt",
quote=F,sep="\t")


write.table(nftools.pat.adjusted.spearman.by.cohort,"frequentist_analysis/more_stringent/nftools.pat.adjusted.spearman.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")
write.table(duohmm.pat.adjusted.spearman.by.cohort,"frequentist_analysis/more_stringent/duohmm.pat.adjusted.spearman.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")
write.table(duohmm2.pat.adjusted.spearman.by.cohort,"frequentist_analysis/more_stringent/duohmm_in_nftools.pat.adjusted.spearman.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")

write.table(summary.nftools.pat.results.by.cohort,"frequentist_analysis/more_stringent/nftools.pat.lme.results.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")
write.table(summary.duohmm.pat.results.by.cohort,"frequentist_analysis/more_stringent/duohmm.pat.lme.results.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")
write.table(summary.duohmm2.pat.results.by.cohort,"frequentist_analysis/more_stringent/duohmm_in_nftools.pat.lme.results.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")

write.table(summary.nftools.pat.adjusted.results.by.cohort,"frequentist_analysis/more_stringent/nftools.pat.lm_on_adjusted_counts.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")
write.table(summary.duohmm.pat.adjusted.results.by.cohort,"frequentist_analysis/more_stringent/duohmm.pat.lm_on_adjusted_counts.by.cohort.no_nkids_term.with_new_QTR.txt",quote=F,sep="\t")
write.table(summary.duohmm2.pat.adjusted.results.by.cohort,"frequentist_analysis/more_stringent/duohmm_in_nftools.pat.lm_on_adjusted_counts.by.cohort.no_nkids_term.with_new_QTR.txt",
quote=F,sep="\t")

save.image("frequentist_analysis/more_stringent/frequentist_analysis_of_MAE.no_nkids_term.with_new_QTR.RData")
