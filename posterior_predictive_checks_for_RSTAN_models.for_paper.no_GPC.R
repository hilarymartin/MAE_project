...
if(argv[1]==1){
    load("RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.model3.adjusted_priors.all_chains.mat.including_alpha.RData")
    ...
    my.model=3
    J=length(y)
    mydir="RSTAN_output_on_duoHMM_more_stringent/no_GPC/model3"
    ...
    load("RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.model3.adjusted_priors.all_chains.pat.including_alpha.RData")
    ...
    load("RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.model3.2.adjusted_priors.all_chains.mat.including_alpha.RData")
...
#remove two FVG children who appear to be MZ twins and who have a very low # of crossovers (1 and 2, vs next lowest 14)
    ...
    mydir="RSTAN_output_on_duoHMM_more_stringent/no_GPC/model3.2"
    ...
    load("RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.model3.2.adjusted_priors.all_chains.pat.including_alpha.RData")
...
#### Model 1.5 -- negative binomial model for informative families only
   load("RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.modell1.5.all_chains.maternal.mu_m_N_37_6.sigmasq_m_IG_5_5.including_alpha.RData")
   ...
   cohort.by.family=data1.mat2$cohort_by_family
    ...
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T,stringsAsFactors=F)
    Age=data1.mat2$Age
    description="model1.5.maternal"
    my.model=1.5
    J=length(y)
    mydir="RSTAN_output_on_duoHMM_more_stringent/no_GPC/model1.5"
...
#### Model 1.5 -- negative binomial model for informative families only
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.modell1.5.all_chains.paternal.mu_m_N_32_6.sigmasq_m_IG_5_5.including_alpha.RData")
    ...
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T,stringsAsFactors=F)
    Age=data1.pat2$Age
...
#### Model 1.6 -- beta_Age drawn from distribution; alphas drawn from N(mu_cohort,sigmasq)
    ...
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.modell1.6.all_chains.mat.including_alpha.mu_m_N_41_100.sigmasq_m_IG_2_40.RData")
    ...
    my.model=1.6
    J=length(y)
    mydir="RSTAN_output_on_duoHMM_more_stringent/no_GPC/model1.6"
    ...
    load("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.modell1.6.all_chains.pat.including_alpha.mu_m_N_27_64.sigmasq_m_IG_2_15.RData")
...
#### Model 1.6.2 -- common beta_Age; alphas drawn from N(mu_cohort,sigmasq)
    ...
    my.model=1.62
    J=length(y)
    mydir="RSTAN_output_on_duoHMM_more_stringent/no_GPC/model1.62"
...
#### Model 1.5.4 -- negative binomial model for informative families only, no cohort effect but family effects drawn from distribution with cohort-specific mean; common beta_Age
    ...
    my.model=1.54
    J=length(y)
    mydir="RSTAN_output_on_duoHMM_more_stringent/no_GPC/model1.54"
    best.draw=sapply(1:(length(mysim)-1),function(i){
        x=mysim[[i]]
        if(class(x)=="array"){
            return(x[which.max(mysim$lp__)])
...
#### Poisson model
    ...
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.Poisson_model.linear_mean.all_chains.mat.including_alpha.mu_m_N_41_100.sigmasq_m_IG_2_40.RData"))
    ...
    cohort.codes=read.delim("RSTAN_output/key_for_maternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T,stringsAsFactors=F)
    Age=data1.mat2$Age
    description="Poisson_model.linear_mean.maternal.mu_m_N_41_100.sigmasq_m_IG_2_40"
    my.model=1
    J=length(y)
    mydir="RSTAN_output_on_duoHMM_more_stringent/no_GPC/Poisson_model.linear_mean"
    ...
    data1.pat2$cohort_by_family = cohort_by_family
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_on_duoHMM_more_stringent/no_GPC/RSTAN.Poisson_model.linear_mean.all_chains.pat.including_alpha.mu_m_N_27_64.sigmasq_m_IG_2_15.RData"))
    mysim<-extract(model1.6.pat,permuted=T)
    y=data1.pat2$y
    cohort=data1.pat2$cohort
    cohort.by.family=data1.pat2$cohort_by_family
    ...
    cohort.codes=read.delim("RSTAN_output/key_for_paternal_cohorts_to_include_in_model_1.more_stringent.no_GPC.txt",header=T,stringsAsFactors=F)
    Age=data1.pat2$Age
    description="Poisson_model.linear_mean.paternal.mu_m_N_27_64.sigmasq_m_IG_2_15"
    my.model=1
    J=length(y)
    mydir="RSTAN_output_on_duoHMM_more_stringent/no_GPC/Poisson_model.linear_mean"
...
simulate_y<-function(N,a0=NA,mu_m=NA,sigmasq_m=NA,beta_Age,age,cohort,cohort.by.family=NA,family,beta_Cohort=NA,p_by_cohort=NA,tausq=NA,omega=NA,model){
  family.effects=c()
...
for(c in 1:length(unique(cohort))){
plot(y_predict[cohort==c],classic_residuals[cohort==c],ylab="estimated residual",xlab="expected count",main=paste0(cohort.codes[cohort.codes$Code==c,"Cohort"]),cex.main=2,cex.lab=1.5,cex.axis=1.5,
...
for(c in 1:length(unique(cohort))){
    plot(density(classic_residuals[cohort==c]),xlab="estimated residuals",main=paste0(cohort.codes[cohort.codes$Code==c,"Cohort"]," distribution of residuals"),cex.main=2,cex.lab=2,cex.axis=2)
...
#    qqnorm(classic_residuals[cohort==c],xlab="Expected",ylab="Observed",main=paste0("QQ plot of residuals for ",cohort.codes[cohort.codes$Code==c,"Cohort"]),cex.main=1,cex.lab=2,cex.axis=2,cex=2)
        qqnorm(classic_residuals[cohort==c],xlab="Expected",ylab="Observed",main=paste0(cohort.codes[cohort.codes$Code==c,"Cohort"]," qq plot"),cex.main=2,cex.lab=2,cex.axis=2,cex=2)
