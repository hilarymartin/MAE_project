...
#model 1.2, paternal
   ...
   mean_alpha_prior=27
    ...
    load(paste0("/well/donnelly/hilary/maternal_age_and_recombination/RSTAN_output_with_NFTOOLS_more_stringent/no_GPC/RSTAN.modell1.6.all_chains.pat.including_alpha.sigmasq_m_IG_",sigmasq_m_alpha,"_",sigmasq_m_beta,".RData"))
